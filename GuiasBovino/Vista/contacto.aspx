<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="contacto.aspx.vb" Inherits="WEB.contacto" %>
              ...
              <ul class="treeview-menu">
                   <%      
                    ...
                    End If
                     ...
                     End If
                 %>
                 <li><a href="crotales_disponibles.aspx" <%=noVisibleCrotalesDisponibles%>><i class="fa fa-circle-o"></i><%= Me.Literales("50029") %></a></li>
                 <li><a href="solicitud_crotales.aspx" <%=noVisibleSolicitudCrotales%>><i class="fa fa-circle-o"></i><%= Me.Literales("50030") %></a></li>
                 <li><a href="relacion_de_solicitudes.aspx" <%=noVisibleRelacionSolicitudes%>><i class="fa fa-circle-o"></i><%= Me.Literales("50031") %></a></li>
             </ul>
         </li>
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("51181") %></h1> 
          <p><%= Me.LiteralesPage("51185") %></p>
      ...
      <section class="content">
        ...
        <div class="row">
          <div class="invoice centrar" >
              ...
              <div class="col-md-6">
                <dl class="contact">
                  <dt><%= Me.LiteralesPage("51182") %>:</dt>
                  <dd><%= Me.LiteralesPage("53708") %></dd>
                  <dt><%= Me.LiteralesPage("51183") %>:</dt>
                   <dd><%= Me.LiteralesPage("53706") %></dd>
                  <dd><%= Me.LiteralesPage("53707") %></dd>
                </dl>
              </div>
              <!--BOTON MANUAL-->
              <div class="col-md-6">
                ...
                <%
                dim url=""
                if NEKAGIP.SessionNekagip.SelectedLanguage="es" then
                    url=Me.ManualCastellano()
                else
                    url=Me.ManualEuskera()
                end if
                %>
                <button class="imprimir" onclick="javascript:window.open('<%=url%>');return false;"><%= Me.LiteralesPage("51184") %></button>
              </div>
            </div>
          </div>
        </div>
