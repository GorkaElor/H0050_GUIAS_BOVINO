<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="solicitud_permiso.aspx.vb" Inherits="WEB.solicitud_permiso" %>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
       ...
       %>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><%= Me.LiteralesPage("52201") %></h1>
                <p><%= Me.LiteralesPage("52202") %></p>
            ...
            <section class="content alta">
                ...
                <div class="row">
                    <div class="invoice permiso-crotalacion">
                        <div class="row">
                            <ul id="messageBox"></ul>
                        </div>
                        <div class="row">
                            <div class="col-md-3 text-center">
                                <img src="img/img_autocrotalacion.png" class="imagen_autocrotalacion"></div>
                            <div class="col-md-9">
                                <h2><%= Me.LiteralesPage("52203") %></h2>
                                <p><%= Me.LiteralesPage("52205") %></p>
                                <p><%= Me.LiteralesPage("52206") %></p>
                                <p><%= Me.LiteralesPage("52207") %></p>
                                <button id="btnSolicitarPermiso"><%= Me.LiteralesPage("52204") %></button>
                            </div>
                            <div id="msg-error" class="solicitud-crotales-form" style="display: none;">
                                <div class="col-md-12 solicitud-error">
                                    <p class="texto3"><%= Me.LiteralesPage("53111") %></p>
                                    <p class="texto4">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                           <%= Me.LiteralesPage("52303") %>
                        </div>
                        <div class="modal-body">
                            <input type="hidden" name="guia" id="guia" value=""/>
                            <span id="message"><%= Me.LiteralesPage("53784")%></span>
                        </div>
    ...
    <script src="JS_CSS/solicitud_permiso/solicitud_permiso.js?<%=Session("version") %>"></script>
</body>
</html>
