<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="bajas_entre_fechas.aspx.vb" Inherits="WEB.bajas_entre_fechas" %>
...
<%--Consulta datos --%>
        ...
        <ul class="treeview-menu">
            ...
            <li class="menu_censo fase2 active"><a href="bajas_entre_fechas.aspx" <%=noVisibleBajasEntreFechas%>><i class="fa fa-circle-o"></i><%= Me.Literales("50039") %></a></li>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
       ...
       <%
           ...
           End If
       %>
        <li class="treeview menu_cambio active" <%=noVisibleConfiguracion%>>
        <a href="#">
        ...
        <ul class="treeview-menu">
            <li class="menu_cambio active"><a href="cambio.aspx" <%=noVisibleCambio%>><i class="fa fa-circle-o"></i><%= Me.Literales("50016") %></a></li>
        </ul>
        </li>
         <%--AYUDA Y CONTACTO--%>
       <%
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("52601") %></h1>
		<p><%= Me.LiteralesPage("52602") %></p>
      </section>
      ...
      <section class="content alta">
        ...
        <div class="row">
          ...
          <div class="invoice">
            <p class="query-text"><%= Me.LiteralesPage("52603") %>:</p>
            <form class="form-inline" id="bajas_entre_fechas" name="bajas_entre_fechas"  method="post">
                 <div class="row">
                    <ul id="messageBox"></ul>
                </div>
              <div class="row">
                <div class="form-group col-md-12">
                  <ul class="custom_radios">
                    <li>
                      <input type="radio" id="c-option" name="selector" checked="checked">
                      <label for="c-option"><%= Me.LiteralesPage("52604") %></label>
                      <div class="check"></div>
                    </li>
                    <li>
                      <input type="radio" id="s-option" name="selector">
                      <label for="s-option"><%= Me.LiteralesPage("52605") %></label>
                      <div class="check"><div class="inside"></div></div>
                    </li>
                    <li>
                      <input type="radio" id="t-option" name="selector">
                      <label for="t-option"><%= Me.LiteralesPage("52606") %></label>
                      <div class="check"><div class="inside"></div></div>
                    </li>
                  </ul>
               </div>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label><%= Me.LiteralesPage("52607") %>:</label>
                  <div class="input-group date fecha_desde">
                    ...
                    <input type="text" class="form-control pull-right" id="fecha_desde">
  			        ...
  			        <div class="form-group col-md-6">
                  <label><%= Me.LiteralesPage("52608") %>:</label>
                  <div class="input-group date fecha_hasta">
                    <div class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                    </div>
              ...
              <div class="text-center row-query-buttons">
                <button class="btn btn-default" type="submit" id="btnPDF"><i class="fa fa-file-pdf-o"></i>PDF</button>
                <button class="btn btn-default" type="submit" id="btnExcel"><i class="fa fa-file-excel-o"></i>Excel</button>
              </div>
  ...
  <!-- page script -->
    ...
    <script src="JS_CSS/bajas_entre_fechas/bajas_entre_fechas.js?<%=Session("version") %>"></script>
</body>
