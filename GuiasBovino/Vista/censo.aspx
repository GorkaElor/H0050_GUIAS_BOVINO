<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="censo.aspx.vb" Inherits="WEB.censo" %>
...
<%--Consulta datos --%>
         <%
             ...
             End If
          %>   
        <li class="treeview menu_censo menu_consulta menu_censo_fecha menu_registro active" <%=noVisibleConsultaDatos%>>
        <a href="#">
        ...
        <ul class="treeview-menu">
            <li class="menu_censo active"><a href="censo.aspx" <%=noVisibleCenso%>><i class="fa fa-circle-o"></i><%= Me.Literales("50008") %></a></li>
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("50701") %></h1>
        <p><%= Me.LiteralesPage("50705") %></p>
      </section>
        ...
        <div class="row">
          <div class="invoice">              
            ...
            <div id="myModal" class="modal fade bs-example-modal-sm in" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
               ...
               <div id="izquierda" style="width:100%; text-align: left;" class="table-responsive">  
                            <p><%= Me.LiteralesPage("50702") %>:</p>
                            <button class="btn btn-default boton_movil" onclick="getAssociatedFileSub('pdf')"><i class="fa fa-file-pdf-o"></i><%= Me.LiteralesPage("50703") %></button>
                            <button class="btn btn-default boton_movil" onclick="getAssociatedFileSub('excel')"><i class="fa fa-file-excel-o"></i><%= Me.LiteralesPage("50704") %></button>
              ...
              <div class="table-responsive">
                          ...
                          <table id="resumen" class="table table-bordered table-striped">
                              <tr>
                                <td ><h3><%=UCase(Me.LiteralesPage("53727"))%></h3></td>
                                <td colspan="5"><b><%=Me.LiteralesPage("53728")%></b>:<input id="total" runat="server" style="width: 50%;border-style: none; background-color: transparent;"/></td>
                            
                              </tr>
                              <tr>
                                  <%--<td rowspan="6" ><%=UCase("resumen") %><br /><br /><b>Total</b>:61</td>--%>
                                  <td > </td>
                                  <td ><%=Me.LiteralesPage("53720")%></td>
                                  <td ><%=Me.LiteralesPage("53721")%></td>
                                  <td ><%=Me.LiteralesPage("53722")%></td>
                                  <td ><%=Me.LiteralesPage("53723")%></td>
                                  <td ><%=Me.LiteralesPage("53724")%></td>
                                 
                              </tr>
                              <tr>
                                  <td ><%=Me.LiteralesPage("53725")%> </td>
                                  <td > <input id="h6" style="width: 50%;border-style: none; background-color: transparent;" runat="server"/></td>
                                  <td ><input id="h612"  style="width: 50%;border-style: none;background-color: transparent;" runat="server"/></td>
                                  <td ><input id="h1224" style="width: 50%;border-style: none;background-color: transparent;" runat="server"/></td>
                                  <td ><input id="h24" style="width: 50%;border-style: none;background-color: transparent;" runat="server"/></td>
                                  <td ><input id="hSum" style="width: 50%;border-style: none;background-color: transparent;" runat="server"/></td>
                                 
                              </tr>
                               <tr>
                                   <td ><%=Me.LiteralesPage("53726")%> </td>
                                  <td ><input id="m6" style="width: 50%;border-style: none;background-color: transparent;" runat="server"/></td>
                                  <td ><input id="m612" style="width: 50%;border-style: none;background-color: transparent;" runat="server"/></td>
                                  <td ><input id="m1224" style="width: 50%;border-style: none;background-color: transparent;" runat="server"/></td>
                                  <td ><input id="m24" style="width: 50%;border-style: none;background-color: transparent;" runat="server"/></td>
                                  <td ><input id="mSum" style="width: 50%;border-style: none;background-color: transparent;" runat="server"/></td>
                        ...
                        <!--   <table id="totalresumen" class="table table-bordered table-striped">
                              <tr>
                                  <td > </td>
                                  <td >hembras</td>
                                  <td >machos</td>
		 ...
		 <div class="table-responsive">
            <table id="tabla-crotales" class="table table-bordered table-striped">                
            </table>
        </div>  
  ...
  <script src="JS_CSS/jquery-2.2.3.min.js?<%=Session("version") %>"></script>
    ...
    <script src="JS_CSS/censo/censo.js?<%=Session("version") %>"></script>
