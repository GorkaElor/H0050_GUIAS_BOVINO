<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="notificar_fecha_colocacion.aspx.vb" Inherits="WEB.notificar_fecha_colocacion" %>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
             ...
             End If
          %> 
        <li class="treeview menu_explotacion menu_titulares menu_asociaciones menu_calificacion">
        <a href="#">
        ...
        <div class="row">
          <div class="invoice">        
		    ...
		    <div class="perdida-data">
		        <h3></h3>
		        <p><span><%= Me.LiteralesPage("52916") %>:</span><span id="id_crotal"></span></p>
		        <p><span><%= Me.LiteralesPage("52713") %>:</span><span id="fecha_entrega"></span></p>
		    </div>
		    <div class="notification-body">
		        <p><%= Me.LiteralesPage("53716") %>:</p>
		        <div class="input-group date fecha_perdida_input">
                    <div class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                    </div>
                    <input type="text" class="form-control pull-right" id="fecha_colocacion">
                </div>

		       
		  </div>
		  <div class="perdida-buttons">
		        <a href="crotales_disponibles.aspx"><button class="btn btn-default icono"><i class="fa fa-chevron-left"></i><%= Me.LiteralesPage("53203") %> </button></a>
		        <button id="btnNotificar" class="btn btn-default icono" onclick="enviar_notificacion_colocacion()"><i class="fa fa-arrow-circle-right"></i><%= Me.LiteralesPage("53717") %> </button>
		  </div>
        </div>
       </div>
  ...
  <!-- ./wrapper -->
    ...
    <script src="JS_CSS/notificar_fecha_colocacion/notificar_fecha_colocacion.js?<%=Session("version") %>"></script>
