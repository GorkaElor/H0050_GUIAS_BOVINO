<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="listado_de_nacimientos.aspx.vb" Inherits="WEB.listado_de_nacimientos" %>
        ...
        <a href="inicio.aspx">
         ...
         <li class="treeview fase2 active" <%=noVisibleSubMenuAltaBaja%>>
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="listado_de_nacimientos.aspx" <%=noVisibleListadoNacimientos%>><i class="fa fa-circle-o"></i><%= Me.Literales("50034") %></a></li>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
       ...
       %>
        ...
        <ul class="treeview-menu">
            <li class="menu_cambio " <%=noVisibleConfiguracion%>><a href="cambio.aspx"><i class="fa fa-circle-o"></i><%= Me.Literales("50016") %></a></li>
        </ul>
        </li>
         <%--AYUDA Y CONTACTO--%>
       <%
       ...
       %>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><%= Me.LiteralesPage("53101") %></h1>
                <p><%= Me.LiteralesPage("53102") %></p>
            </section>
              ...
              <div class="invoice disable-box">
                ...
                <div class="box-body">
                     ...
                     <div class="table-responsive">
                        <table id="table-nacimientos" class="table table-bordered table-striped">                
                        </table>
                    </div>  
    ...
    <script src="JS_CSS/listado_de_nacimientos/listado_de_nacimientos.js?<%=Session("version") %>"></script>
</body>
