<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="censo_fecha.aspx.vb" Inherits="WEB.censo_fecha" %>
...
<%--Consulta datos --%>
        ...
        <ul class="treeview-menu">
            ...
            <li class="menu_censo_fecha active"><a href="censo_fecha.aspx" <%=noVisibleCensoAUnaFecha%>><i class="fa fa-circle-o"></i><%= Me.Literales("50010") %></a></li>
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("50901") %></h1>
        <p><%= Me.LiteralesPage("50906") %></p>
      </section>
            ...
            <!-- <form class="form-inline">     -->
              ...
              <div>
                ...
                <div class="form-group">
                  <label class="ancho80"><%= Me.LiteralesPage("50903") %>:</label>
                  <div class="input-group date">
                    <div class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                    </div>
                    <input type="text" class="form-control pull-right" id="fecha_salida">
                  </div>
