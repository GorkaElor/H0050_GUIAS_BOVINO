<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="header_sidebar.aspx.vb" Inherits="WEB.header_sidebar" %>
...
<header class="main-header">
    ...
    <div class="navbar-custom-menu">
        ...
        <li><a id="languageEU" href="#" runat="server">EU</a></li>
        <li><a id="languageES" href="#" runat="server">ES</a></li>
        </ul>
...
<div class="col-md-8">
    ...
    <div id="ficha" class="ficha" runat="server">
    </div>
</div>
</div>
    ...
    <div class="user-panel">
        ...
        <div class=" info">
        <p id="sidebar_nombre_usuario" runat="server"></p>
