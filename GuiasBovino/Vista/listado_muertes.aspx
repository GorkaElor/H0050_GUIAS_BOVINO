<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="listado_muertes.aspx.vb" Inherits="WEB.listado_de_muertes" %>
        ...
        <%--Gestión de crotales--%>
         ...
         <li class="treeview fase2 active" <%=noVisibleSubMenuAltaBaja%>>
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="listado_muertes.aspx" <%=noVisibleListadoMuertes%>><i class="fa fa-circle-o"></i><%= Me.Literales("50035") %></a></li>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
       ...
       %>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><%= Me.LiteralesPage("53001") %></h1>
                <p><%= Me.LiteralesPage("53002") %></p>
            </section>
          ...
          <div class="invoice disable-box">
            ...
            <div class="box-body">
                 ...
                 <div class="table-responsive">
                        <table id="table-muertes" class="table table-bordered table-striped">                
                        </table>
                 </div>  
    ...
    <script src="JS_CSS/listado_de_muertes/listado_de_muertes.js?<%=Session("version") %>"></script>
</body>
