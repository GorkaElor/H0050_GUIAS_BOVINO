<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="documentaciones.aspx.vb" Inherits="WEB.documentaciones" %>
 ...
 End If
    ...
    <div class="content-wrapper">
      <!-- Content Header (Page header) -->
        ...
        <h1><%= Me.LiteralesPage("53868") %></h1>
		<p><%= Me.LiteralesPage("53867") %></p>
      ...
      <section class="content alta">
            ...
            <div class="invoice disable-box">
                ...
                <h3 class="numero_crotales_disp"><span id="numDocumentaciones" runat="server"></span> <%= Me.LiteralesPage("53866") %> / <span id="numDocumentacionesTotales" runat="server"></span> <%= Me.LiteralesPage("53868") %></h3>

                <div class="box-body">

                    <div class="table-responsive">
                    <table id="table-documentaciones" class="table table-bordered table-striped">                
                    </table>
                    </div>      
  ...
  <!-- page script -->
    ...
    <script src="JS_CSS/documentaciones/documentaciones.js?<%=Session("version") %>"></script>
</body>
