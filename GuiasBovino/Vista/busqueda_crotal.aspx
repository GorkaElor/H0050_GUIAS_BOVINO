<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="busqueda_crotal.aspx.vb" Inherits="WEB.busqueda_crotal" %>
 ...
 noVisibleListadoSaneamientos = "style='display:none'"
      ...
      <%--busqueda crotal--%>
       <%           Dim noVisibleBusquedaCrotal= ""
           ...
           End If
       %>        <li class="active" <%=noVisibleBusquedaCrotal%>>        <a href="busqueda_crotal.aspx">            <i class="fa fa-search active" ></i> <span><%= Me.Literales("53786") %></span>        </a>        </li>		
<%--Consulta datos --%>
         <%
...
Dim noVisibleMontesAutorizados=""
 ...
 <script>
     function llamarImprimirFichaRes() {
         crotal = $("#crotal").val();
         debugger;
         //if (crotal.length!=14){
         //    message = "<li><label class='validationerror'>El crotal consta de 14 caracteres</label></li>";
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("53786") %></h1>
        <p><%= Me.LiteralesPage("53791") %></p>
      </section>
            ...
            <!-- <form class="form-inline">     -->
              ...
              <div>
                ...
                <div class="form-group">
                  <label style="vertical-align:top;display:inline;margin-right:5px" class=ancho80"><%= Me.LiteralesPage("53789") %>:</label>
                   
                    <input type="text" class="form-control pull-right" style="vertical-align:top" id="crotal">  
                
                </div>
                  <button style="vertical-align:top" id="btnimprimirFichaRes" class="btn btn-default boton_movil" onclick="llamarImprimirFichaRes()" ><i class="fa fa-file-pdf-o"></i><%= Me.LiteralesPage("53790") %></button>
  ...
  <script src="JS_CSS/jquery-2.2.3.min.js?<%=Session("version") %>"></script>
    ...
    <script src="JS_CSS/censo_fecha/censo_fecha.js?<%=Session("version") %>"></script>
