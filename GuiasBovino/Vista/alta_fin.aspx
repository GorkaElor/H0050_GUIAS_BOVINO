<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="alta_fin.aspx.vb" Inherits="WEB.alta_fin" %>
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("50601") %></h1>
        <p><%= Me.LiteralesPage("50602") %></p>
      ...
      <section class="content alta">
        <div class="row">
          <ul class="pasos">
            <li><%= Me.LiteralesPage("50603") %> 1 <span><%= Me.LiteralesPage("50604") %></span></li>
            <li><%= Me.LiteralesPage("50603") %> 2 <span><%= Me.LiteralesPage("50605") %></span></li>
            <li class="activo"><%= Me.LiteralesPage("50603") %> 3 <span><%= Me.LiteralesPage("50606") %></span></li>
          </ul>
        </div>
        <div class="row">

          <div class="invoice centrar">
            <div id="guia_correcta" runat="server">
                <p class="texto1"><%= Me.LiteralesPage("50607") %></p>
                <p class="texto2" id="ws_messsage_ok" runat="server"></p>
                <p ><%= Me.LiteralesPage("50609") %></p>

                <button id="doc_guia" style="display:none" class="imprimir"  onclick="getAssociatedFileSub('guia')" runat="server"><%= Me.LiteralesPage("50610") %></button>
                <button id="doc_matadero" style="display:none" class="imprimir"  onclick="getAssociatedFileSub('matadero')" runat="server"><%= Me.LiteralesPage("50611") %></button>
            </div>
              <div id="guia_incorrecta" runat="server">       
                <p class="texto1"><%= Me.LiteralesPage("50612") %></p>           
                <p class="texto2" id="ws_messsage_nok" runat="server"></p>
                <div class="botonera">
                    <a id="btnCancelar" href="alta1.aspx" class="pull-right cancelar"><%= Me.LiteralesPage("50613") %></a>
                </div>
              </div>
          </div>
  ...
  <script src="JS_CSS/jquery-2.2.3.min.js?<%=Session("version") %>"></script>
    ...
    <script src="JS_CSS/alta_fin/alta_fin.js?<%=Session("version") %>"></script>
