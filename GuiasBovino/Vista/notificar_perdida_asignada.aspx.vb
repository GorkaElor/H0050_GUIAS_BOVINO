...
Public Class notificar_perdida_asignada
    Inherits CustomPage
    ...
    Public Shared Function notificarPerdida(ByVal crotal As String, ByVal fechaPerdida As String, ByVal fechaNotificacion As String,
                                            ByVal tipoBaja As String, ByVal observaciones As String) As String
        Try
            Dim output As WSOutput.NotificarPerdida = SessionNekagip.ExplotacionSeleccionada.NotificarPerdida(crotal, "2", "", fechaNotificacion, fechaPerdida, observaciones)
