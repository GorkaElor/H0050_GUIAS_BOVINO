<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="error.aspx.vb" Inherits="WEB._error" %>
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content alta">
        ...
        <div class="row">
          <div class="invoice">
            <div class="error"><i class="fa fa-times"></i><p><%= Me.LiteralesPage("51172") %></p></div>
          </div>
        </div>
