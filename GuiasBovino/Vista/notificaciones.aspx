<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="notificaciones.aspx.vb" Inherits="WEB.notificaciones" %>
 ...
 End If
    ...
    <div class="content-wrapper">
      <!-- Content Header (Page header) -->
        ...
        <h1><%= Me.LiteralesPage("53401") %></h1>
		<p><%= Me.LiteralesPage("53402") %></p>
      ...
      <section class="content alta">
            ...
            <div class="invoice disable-box">
                ...
                <h3 class="numero_crotales_disp"><span><%= Session("Notificaciones") %></span> <%= Me.LiteralesPage("53403") %> / <span id="notificaciones_totales"></span> <%= Me.LiteralesPage("53404") %></h3>

                <div class="box-body">

                    <div class="table-responsive">
                    <table id="table-notificaciones" class="table table-bordered table-striped">                
                    </table>
                    </div>      
            ...
            <%--alert modal para mostrar que ne eliminó la notificación --%>
           <div class="modal fade" id="alert-confirmacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                             <span id="cabecera"><%= Me.LiteralesPage("53405") %></span>
                        </div>
                        <div class="modal-body">
                            <span id="message"><%= Me.LiteralesPage("53406") %></span>
                        </div>
                        <div class="modal-footer">
                            <a class="btn btn-success btn-ok"><%= Me.LiteralesPage("53407") %></a> <%--Aceptar--%>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <%-- Confirm modal para eliminar notificación --%>
            <div class="modal fade" id="confirm-eliminar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <%= Me.LiteralesPage("53413") %> <%--Confirmación de eliminación de notificación--%>
                        </div>
                        <div class="modal-body">
                            <input type="hidden" name="guia" id="guia" value=""/>
                            <%= Me.LiteralesPage("53414") %> <%--¿Está seguro de eliminar esta notificación?--%>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-dismiss="modal"><%= Me.LiteralesPage("53415") %></button> <%--Cancelar--%>
                            <a class="btn btn-success btn-ok"><%= Me.LiteralesPage("53416").ToString.ToUpper() %></a> <%--Aceptar--%>
                        </div>
                    </div>
                </div>
                </div>
  ...
  <!-- page script -->
    ...
    <script src="JS_CSS/notificaciones/notificaciones.js?<%=Session("version") %>"></script>
</body>
