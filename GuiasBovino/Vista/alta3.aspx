<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="alta3.aspx.vb" Inherits="WEB.alta3" %>
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("50501") %></h1>
        <p><%= Me.LiteralesPage("50502") %></p>
      ...
      <section class="content alta">
        <div class="row">
          <ul class="pasos">
            <li><%= Me.LiteralesPage("50503") %> 1 <span><%= Me.LiteralesPage("50504") %></span></li>
            <li><%= Me.LiteralesPage("50503") %> 2 <span><%= Me.LiteralesPage("50505") %></span></li>
            <li class="activo"><%= Me.LiteralesPage("50503") %> 3 <span><%= Me.LiteralesPage("50506") %></span></li>
          </ul>
        </div>
        <div class="row">
          ...
          <form action="" class="form-inline">
            <div class="invoice">
              ...
              <h2><%= Me.LiteralesPage("50507") %>:</h2>
              <div class="row">
                <div class="col-md-12">
                  <dl class="lista_resumen">
                    <dt><%= Me.LiteralesPage("50508") %>:</dt>
                    <dd id="txtExpDestino" runat="server" ></dd>
                    <dt><%= Me.LiteralesPage("50509") %>:</dt>
                    <dd id="txtExpDestinoNombre" runat="server" ></dd>
                    <dt><%= Me.LiteralesPage("50510") %>:</dt>
                    <dd id="txtMunicipio" runat="server" ></dd>
                    <dt><%= Me.LiteralesPage("50511") %>:</dt>
                    <dd id="txtProvincia" runat="server" ></dd>
                    <dt><%= Me.LiteralesPage("50512") %>:</dt>
                    <dd id="txtFechaSalida" runat="server" ></dd>
                    <dt><%= Me.LiteralesPage("50513") %>:</dt>
                    <dd id="txtFechaLlegada" runat="server" ></dd>
                    <dd id="txtHoraSalida" runat="server" ></dd>
                      <dd id="txtHorallegada" runat="server" ></dd>
                    <dt id="litComprador" runat="server"><%= Me.LiteralesPage("53719") %>:</dt>
                    <dd id="txtComprador" runat="server" ></dd>

                  </dl>
                  <h3><%= Me.LiteralesPage("50514") %></h3>
                    <div id="tipotransporte" runat ="server" >                                              

                    </div>
                   <dl class="lista_resumen" id="transportista" runat ="server" >
                        <dt ><%= Me.LiteralesPage("50509") %>:</dt>
                        <dd id="txtTransportistaNombre" runat="server" ></dd>
                        <dt><%= Me.LiteralesPage("50515") %>:</dt>
                        <dd id="txtMatricula" runat="server" ></dd>
                        <dt><%= Me.LiteralesPage("50516") %>:</dt>
                        <dd id="txtTransportistaDNI" runat="server" ></dd>
                        <dt><%= Me.LiteralesPage("50517") %>:</dt>
                        <dd id="txtATES" runat="server" ></dd>
                    </dl>
                  
                  <h3><%= Me.LiteralesPage("50518") %></h3>
                  <ul id="ulCrotales" runat="server" class="lista_resumen">
                  </ul>
                </div>
            ...
            <div id="ica" runat="server">
                    <input type="checkbox" class="" id="acuerdoICA">
                    <label for="acuerdoICA"><%= Me.LiteralesPage("53780") %></label>
             </div>
             <div class="botonera">
             <a id="btnPasoAnterior" href="alta2.aspx" class="pull-left"><%= Me.LiteralesPage("50520") %></a> 
            <a id="btnRellenarICA" href="ica1.aspx" class="pull-right"><%= Me.LiteralesPage("53781") %></a>
             <a id="btnFinalizar" href="alta_fin.aspx" class="pull-right"><%= Me.LiteralesPage("50519") %></a>
             <a id="btnCancelar" href="alta1.aspx" class="pull-right cancelar"><%= Me.LiteralesPage("50521") %></a>
  ...
  <script src="JS_CSS/jquery-2.2.3.min.js?<%=Session("version") %>"></script>
    ...
    <script src="JS_CSS/alta3/alta3.js?<%=Session("version") %>"></script>
