<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="montesautorizados.aspx.vb" Inherits="WEB.montesautorizados" %>
...
<%--Consulta datos --%>
 ...
 End If
             ...
             End If
          %> 
        <li class="treeview menu_explotacion menu_titulares menu_asociaciones menu_montesautorizados active" <%=noVisibleDatosExplotacion%>>
        <a href="#">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("53831") %></h1>
        <p><%= Me.LiteralesPage("53832") %></p>
  ...
  <!-- page script -->  
    ...
    <script src="JS_CSS/montesautorizados/montesautorizados.js?<%=Session("version") %>"></script>
</body>
