<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="altas_entre_fechas.aspx.vb" Inherits="WEB.altas_entre_fechas" %>
...
<%--Consulta datos --%>
        ...
        <ul class="treeview-menu">
            ...
            <li class="menu_censo fase2"><a href="altas_entre_fechas.aspx active" <%=noVisibleAltasEntreFechas%>><i class="fa fa-circle-o"></i><%= Me.Literales("50038") %></a></li>
 ...
 End If
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1><%= Me.LiteralesPage("52501") %></h1>
		<p><%= Me.LiteralesPage("52502") %></p>
      </section>
      ...
      <section class="content alta">
        ...
        <div class="row">
          ...
          <div class="invoice">
            <p class="query-text"><%= Me.LiteralesPage("52503") %>:</p>
            <form class="form-inline" id="altas_entre_fechas" name="altas_entre_fechas"  method="post">
				...
				<div class="form-group col-md-12">
                    ...
                    <ul class="custom_radios">  
                        <li>
                            ...
                            <label for="s-option"><%= Me.LiteralesPage("52504") %></label>
                        ...
                        <li>
                            ...
                            <label for="t-option"><%= Me.LiteralesPage("52505") %></label>
			...
			<div class="row">
               <div class="form-group col-md-6">
                  <label><%= Me.LiteralesPage("52506") %>:</label>
				 ...
				 <div class="form-group col-md-6">
                  <label><%= Me.LiteralesPage("52507") %>:</label>
  ...
  <!-- page script -->
    ...
    <script src="JS_CSS/altas_entre_fechas/altas_entre_fechas.js?<%=Session("version") %>"></script>
</body>
