<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="seguimiento_san_vac.aspx.vb" Inherits="WEB.seguimiento_san_vac" %>
...
<%--Consulta datos --%>
        ...
        <ul class="treeview-menu">
            ...
            <li class="menu_seguimiento active"><a href="seguimiento_san_vac.aspx" <%=noVisibleSeguimiento%>><i class="fa fa-circle-o"></i><%= Me.Literales("53853") %></a></li>
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("53856") %></h1>
        <p><%= Me.LiteralesPage("53854") %></p>
      </section>
  ...
  <script src="JS_CSS/jquery-2.2.3.min.js?<%=Session("version") %>"></script>
    ...
    <script src="JS_CSS/seguimiento_san_vac/seguimiento_san_vac.js?<%=Session("version") %>"></script>
