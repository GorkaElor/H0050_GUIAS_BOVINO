   ...
   <ul class="sidebar-menu">
        ...
        <a href="inicio.aspx">
         ...
         <%
             ...
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("GES_CROTALES") = True)  Then
         ...
         <li class="treeview fase2" <%=noVisibleGestioCrotales%>>
              ...
              <ul class="treeview-menu">
                 <%      
                     ...
                     If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("CRO_DISPONIBLES"))   Then
                         noVisibleCrotalesDisponibles = "style='display:none'"
                     End If
                     If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("SOLICITUD_CRO"))   Then
                         noVisibleSolicitudCrotales = "style='display:none'"
                     End If
                     
                         If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("RELACION_CRO") )  Then
                         noVisibleRelacionSolicitudes = "style='display:none'"
                    End If
                     If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("REL_ASIG_SERIES"))   Then
         ...
         <%
             ...
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("TRAB_MONTES")) and (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("ALT_BAJ_ANIMALES"))   Then
         ...
         <li class="treeview fase2" <%=noVisibleSubMenuAltaBaja%>>
            ...
            <ul class="treeview-menu">
                <% 
                    If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("NOT_NACIMIENTO"))   Then
                        
                     noVisibleNotificarNacimiento = "style='display:none'"
                    End If
                    If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("NOT_MUERTE"))   Then
                        noVisibleNotificarMuerte = "style='display:none'"
                    End If
                    If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("LIST_NACIMIENTO"))   Then
                        noVisibleListadoNacimientos = "style='display:none'"
                    End If
                    If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("LIST_MUERTE"))   Then
                        noVisibleListadoMuertes = "style='display:none'"
                    End If
                    If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("TRAB_MONTES")) and (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("CONFIRM_GUIA"))   Then
         ...
         <%
             ...
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("TRAB_MONTES")) And (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("SANEAMIENTOS")) And (Not (isPropia And NEKAGIP.SessionNekagip.PermisosData.lista.Contains("TRA_EXP_PROP"))) Then
          ...
          %>
            ...
            <ul class="treeview-menu">
                 <% 
                     ...
                     If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("LIST_SANEAMIENTOS")) And (Not (isPropia And NEKAGIP.SessionNekagip.PermisosData.lista.Contains("TRA_EXP_PROP"))) Then
                         noVisibleListadoSaneamientos = "style='display:none'"
                     End If
                 %>
       ...
       <%           Dim noVisibleBusquedaCrotal= ""
           If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("BUSQUEDA_CROTAL"))   Then
       ...
       <%--Consulta datos --%>
         <%
             ...
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("TRAB_MONTES")) and (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("CONSULTA_DAT"))   Then
                 noVisibleConsultaDatos = "style='display:none'"
             End If
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("TRAB_MONTES")) and (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("CENSO_ACTUAL"))   Then
                 noVisibleCenso = "style='display:none'"
             End If
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("ALTAS_FECHAS"))   Then
                 noVisibleAltasEntreFechas = "style='display:none'"
             End If
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("BAJAS_FECHAS"))   Then
                 noVisibleBajasEntreFechas = "style='display:none'"
             End If
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("CENSO_FECHAS"))   Then
                 noVisibleCensoAUnaFecha = "style='display:none'"
             End If
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("TRAB_MONTES")) and (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("GUIAS"))   Then
                 noVisibleGuiasRealizadas = "style='display:none'"
             End If
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("LIBRO_REG"))   Then
                 noVisibleLibroRegistro = "style='display:none'"
             End If
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("SEGUIMIENTO_SAN_VAC")) And (Not (isPropia And NEKAGIP.SessionNekagip.PermisosData.lista.Contains("TRA_EXP_PROP"))) Then
...
Dim noVisibleMontesAutorizados=""
             ...
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("EXPLOTACION"))   Then
                 noVisibleDatosExplotacion = "style='display:none'"
             End If
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("EXP_DATOS"))   Then
                 noVisibleDatos = "style='display:none'"
             End If
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("EXP_TITULARES") )  Then
                 noVisibleTitulares = "style='display:none'"
             End If
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("EXP_ASOCIACIONES"))   Then
                 noVisibleAsociaciones = "style='display:none'"
             End If
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("EXP_CALIFICA"))   Then
                 noVisibleCalificacion = "style='display:none'"
 End If
              If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("EXP_MONTES"))   Then
        ...
        <ul class="treeview-menu">
         ...
         <%
             ...
             If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("HISTORIAL"))   Then
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("50101") %></h1>
        <p><%= Me.LiteralesPage("50105") %></p>
      </section>
      <!-- Main content -->
  ...
  <!-- page script -->
    ...
    <script src="JS_CSS/index/index.js?<%=Session("version") %>"></script>
</body>
