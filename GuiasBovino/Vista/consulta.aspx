<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="consulta.aspx.vb" Inherits="WEB.consulta" %>
...
<%--Consulta datos --%>
        ...
        <ul class="treeview-menu">
            ...
            <li class="menu_consulta active"><a href="consulta.aspx" <%=noVisibleGuiasRealizadas%>><i class="fa fa-circle-o"></i><%= Me.Literales("50009") %></a></li>
 ...
 <%--CONFICURACION--%>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("50801") %></h1>
        <p><%= Me.LiteralesPage("50814") %></p>
      </section>
       ...
       <section class="content_search">
              ...
              <form class="form-horizontal">
                    <div class="form-group">
                            ...
                            <label for="crotal" class="col-md-2 col-xs-4 control-label"><%= Me.LiteralesPage("50811") %>:</label>
                            <input type="text" class=" col-md-2 col-xs-4 " id="crotal"  >

                            <%--<label for="crotal" class="col-md-1 control-label"><%= Me.LiteralesPage("50813") %>:</label>
                            <input type="text" class="form-control col-md-2" id="explotacion"  style="width:150px;">--%>

                            
                                <button id="buscarCrotal" class="col-xs-6 col-md-2"><i class="fa fa-list"></i><%= Me.LiteralesPage("50812") %></button>
      ...
      <!-- Main content -->
      <section class="content" id="sectionDatatable">
  ...
  <!-- page script -->
    ...
    <script>
        ...
        var permisoAnularGuia = '<%=NEKAGIP.SessionNekagip.PermisosData.lista.Contains("ANULAR_GUIA")%>';
    ...
    <script src="JS_CSS/consulta/consulta.js?<%=Session("version") %>"></script>
</body>
