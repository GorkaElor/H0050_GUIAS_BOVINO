<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="relacion_de_series.aspx.vb" Inherits="WEB.relacion_de_series" %>
       ...
       <%--Gestión de crotales--%>
         ...
         <li class="treeview fase2 active" <%=noVisibleGestioCrotales%>>
              ...
              <ul class="treeview-menu">
                 ...
                 <li class="active" <%=noVisibleRelacionSeries%>><a href="relacion_de_series.aspx"><i class="fa fa-circle-o"></i><%= Me.Literales("53799") %></a></li>
             </ul>
         </li>
...
<%--Consulta datos --%>
        ...
        <ul class="treeview-menu">
            ...
            <li class="menu_registro"><a href="relacion_de_series.aspx" <%=noVisibleLibroRegistro%>><i class="fa fa-circle-o"></i><%= Me.Literales("50011") %></a></li>
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("53798") %></h1>
        <p><%= Me.LiteralesPage("53795") %></p>
      </section>
      ...
      <section class="content alta">
        ...
        <div class="row">
          ...
          <div class="invoice">
                <%
                    Dim noVisibleAltaSeries
                    If (Not NEKAGIP.SessionNekagip.PermisosData.lista.Contains("ASIG_SERIES")) Then
                        noVisibleAltaSeries = "hidden='hidden'"
                    End If
               %>
                 <div  class="row" <%=noVisibleCambio%>>
                      <label for="mensajeAlta"><%=Me.LiteralesPage("53806") %>:</label>
                     <button class="btn btn-default icono" id="btnAlta"><i class="fa fa-plus"></i> Alta</button>
                 </div>
                        ...
                        <div class="modal-content">
                             ...
                             <div class="col-md-12">
                              <div class="form-group">
                                <label for="fecha_notificacion"><%= Me.LiteralesPage("51132")%>:</label>
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                <label for="marcaelectronica"><%= Me.LiteralesPage("53796") %>:</label>
                                <input class="form-control" id="medes" value="<%=  Me.LiteralesPage("53802") %>" readonly="" type="text">
                                  <!--<input class="form-control" id="mecod" value="<%= "1" %>" readonly="" type="text" hidden="hidden">-->
                              </div>
                            </div>
                            <div class="row">
                                  <div class="form-group col-md-12">
                                    <label><%=  Me.LiteralesPage("53797") %>:</label>
                                    <select name="ocas" id="ocas" aria-controls="ocas" class="form-control input-md" runat="server">
                            ...
                            <div class="row">
                                  <div class="form-group col-md-12">
                                    <label><%=  Me.LiteralesPage("53803")%>:</label>
                                    <input name="cadesde" id="cadesde">
                            ...
                            <div class="row">
                                  <div class="form-group col-md-12">
                                    <label><%=Me.LiteralesPage("53804")%>:</label>
                                      <input name="cahasta" id="cahasta" >
                            ...
                            <div class="row">
                                  <div class="form-group col-md-12">
                                    <label><%= Me.LiteralesPage("53805") %>:</label>
                                      <input name="caactual" id="caactual" >
                              ...
                              <div class="row">
                                 ...
                                 <button id="btnGuardar" class="btn btn-default"><i class="fa fa-pencil"></i><%=  Me.LiteralesPage("53800") %></button>
                                 <button id="btnCerrar" class="btn btn-default"><i class="fa fa-pencil"></i><%=  Me.LiteralesPage("53415") %></button>
                             </div>
                        </div>
                    </div>
                </div>
            <div class="box-body">
              <div class="table-responsive">
                <table id="relacionSeries" class="table table-bordered table-striped">
                </table>
              </div>
            </div>
...
<!-- page script -->  
    ...
    <script src="JS_CSS/relacion_de_series/relacion_de_series.js?<%=Session("version") %>"></script>
</body>
