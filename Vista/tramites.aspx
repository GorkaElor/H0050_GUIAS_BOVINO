<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tramites.aspx.vb" Inherits="WEB.tramites" %>
 ...
 End If
        ...
        <ul class="treeview-menu">
         ...
         <%
             ...
             End If
        %>
        <li class="menu_tramites active" <%=noVisibleTramites%>>
        <a href="tramites.aspx">
            <i class="fa fa-list active"></i> <span><%= Me.Literales("50005") %></span>
        </a>
        </li>
         <%--CONFICURACION--%>
       <%
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("51151") %></h1>
        <p><%= Me.LiteralesPage("51154") %></p>
             ...
             <div class="panel-group">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h3 class="panel-title collapsed"><a data-toggle="collapse" href="#collapse1" class="flecha"><%= Me.LiteralesPage("51155") %>:</a></h3>
                  </div>
                  <div id="collapse1" class="panel-collapse collapse in">
                    <div class="panel-body">

                      <form class="form-inline" id="tramites" name="tramites"  method="post">
                        <div class="row">
                          <div class="form-group col-md-12">
                            <label><%= Me.LiteralesPage("51156") %>:</label>
                            <select name="tipoTramite" id="tipoTramite" aria-controls="tabla-crotales" class="form-control input-md" runat="server">
                        ...
                        <div class="row">
                          <div class="form-group col-md-6">
                            <label><%= Me.LiteralesPage("51157") %>:</label>
                            <div id="fecha_desde_group" class="input-group date">
                              <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                              </div>
                              <input type="text" class="form-control pull-right" id="fecha_desde">
                            </div>
                          </div>
                          <div class="form-group col-md-6">
                            <label><%= Me.LiteralesPage("51158") %>:</label>
                            <div id="fecha_hasta_group" class="input-group date">
                              <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                              </div>
                              <input type="text" class="form-control pull-right" id="fecha_hasta" name="fecha_hasta">
                            </div>
                          </div>
                        </div>

                        <div class="row text-center row-query-buttons">
                          <button  class="btn btn-default" id="limpiar" name ="limpiar" onclick="javascript:limpiarFiltros(); return false;"><%= Me.LiteralesPage("51159") %></button>
                          <button type="submit" class="btn btn-default" id="filtrar" name ="filtrar"><%= Me.LiteralesPage("51160") %></button>
                ...
                <label id="etiqueta_ultimos" style="color:red;font:bold " hidden >(*)<%= Me.LiteralesPage("53870") %></label>

              <div class="table-responsive">
                <table id="tramHistTable" class="table table-bordered table-striped">
                </table>
              </div>
            </div>
          </div>
  ...
  <!-- jQuery 2.2.3 -->
    ...
    <script src="JS_CSS/tramites/tramites.js?<%=Session("version") %>"></script>
