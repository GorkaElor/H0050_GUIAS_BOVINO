<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="alta2.aspx.vb" Inherits="WEB.alta2" %>
...
<head>
 ...
 <%-- <link rel="stylesheet" href="../recursos/AdminLTEv2/plugins/datatables/responsive.dataTables.min.css?<%=Session("version") %>">
  <link rel="stylesheet" href="../recursos/AdminLTEv2/plugins/datatables/buttons.dataTables.min.css?<%=Session("version") %>">--%>
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("50401") %></h1>
        <p><%= Me.LiteralesPage("50402") %></p>
      ...
      <section class="content alta">
         <div class="row">
          <ul class="pasos">
            <li><%= Me.LiteralesPage("50403") %> 1 <span><%= Me.LiteralesPage("50404") %></span></li>
            <li class="activo"><%= Me.LiteralesPage("50403") %> 2 <span><%= Me.LiteralesPage("50405") %></span></li>
            <li><%= Me.LiteralesPage("50403") %> 3 <span><%= Me.LiteralesPage("50406") %></span></li>
          </ul>
        </div>
        <div class="row">
              ...
              <div class="box-body">
                <div class="table-responsive">
                  <table id="tabla-crotales" class="table table-bordered table-striped">
                    ...
                    <div class="modal fade" id="alert-crotales" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <%= Me.LiteralesPage("50405") %> 
                                </div>
                                <div class="modal-body">
                                    <input type="hidden" name="guia" id="guia" value=""/>
                                    <%= Me.LiteralesPage("50418") %> 
                                </div>
                                <div class="modal-footer">
                                    <a class="btn btn-success btn-ok"><%= Me.LiteralesPage("50419") %></a> 
                                </div>
                            </div>
                        </div>
                     </div>
               ...
               <div class="modal-body"><%= "(*)50 Animales máximo por guia." %></div>


            <div class="botonera">
              <a id="btnPasoAnterior" href="alta1.aspx" class="pull-left"><%= Me.LiteralesPage("50415") %></a>
              <a id="btnSiguientePaso" href="alta3.aspx" class="pull-right"><%= Me.LiteralesPage("50414") %></a>
              <a id="btnCancelar" href="alta1.aspx" class="pull-right cancelar"><%= Me.LiteralesPage("50416") %></a>
            </div>
          </form>
  ...
  <script src="JS_CSS/jquery-2.2.3.min.js?<%=Session("version") %>"></script>
   ...
   <%-- <script src="../recursos/AdminLTEv2/plugins/datatables/dataTables.responsive.min.js?<%=Session("version") %>"></script>
    <script src="../recursos/AdminLTEv2/plugins/datatables/dataTables.buttons.min.js?<%=Session("version") %>"></script>
    <script src="../recursos/AdminLTEv2/plugins/datatables/buttons.colVis.min.js?<%=Session("version") %>"></script>--%>
    ...
    <script>
       ...
       <%
        if NEKAGIP.SessionNekagip.GuideData.monteautorizado is nothing then%>
        var animalespermitidospasto = '<%=""%>';
        <%else%>
        var animalespermitidospasto='<%=NEKAGIP.SessionNekagip.GuideData.monteautorizado.animalesporsubir%>';
        <%end if%>
         var tipoguia='<%=NEKAGIP.SessionNekagip.GuideData.tipoguia%>';

        var selectedLanguageDataTableDateType;
        InitializeCommon();
    </script>    

    <script src="JS_CSS/alta2/alta2.js?<%=Session("version") %>"></script>
