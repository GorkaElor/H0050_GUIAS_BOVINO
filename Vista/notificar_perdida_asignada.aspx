<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="notificar_perdida_asignada.aspx.vb" Inherits="WEB.notificar_perdida_asignada" %>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
        ...
        <div class="row">
          <div class="invoice">        
		    ...
		    <div class="perdida-data">
		        <h3><%= Me.LiteralesPage("53502") %></h3>
		        <p><span><%= Me.LiteralesPage("53503") %>:</span><span id="id_crotal"></span></p>
		        <p><span><%= Me.LiteralesPage("53504") %>:</span><span id="fecha_actual"></span></p>
		    </div>
		    <div class="notification-body">
		        <p><%= Me.LiteralesPage("53505") %>:</p>
		        <div class="input-group date fecha_perdida_input">
                    <div class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                    </div>
                    <input type="text" class="form-control pull-right" id="fecha_perdida">
                </div>

		        <p><%= Me.LiteralesPage("53506") %>:</p>
		        <textarea placeholder="<%= Me.LiteralesPage("53509") %>" id="observaciones"></textarea>
		  </div>
		  <div class="perdida-buttons">
		        <a href="crotales_disponibles.aspx"><button class="btn btn-default icono"><i class="fa fa-chevron-left"></i><%= Me.LiteralesPage("53507") %> </button></a>
		        <button id="btnNotificar" class="btn btn-default icono"><i class="fa fa-arrow-circle-right"></i><%= Me.LiteralesPage("53508") %> </button>
  ...
  <!-- ./wrapper -->
    ...
    <script src="JS_CSS/notificar_perdida_asignada/notificar_perdida_asignada.js?<%=Session("version") %>"></script>
