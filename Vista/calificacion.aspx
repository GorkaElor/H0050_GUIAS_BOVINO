<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="calificacion.aspx.vb" Inherits="WEB.calificacion" %>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
        ...
        <ul class="treeview-menu">
            ...
            <li class="menu_calificacion active"><a href="calificacion.aspx" <%=noVisibleCalificacion%>><i class="fa fa-circle-o"></i><%= Me.Literales("50015") %></a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("51142") %></h1>
        <p><%= Me.LiteralesPage("51144") %></p>
          ...
          <div class="invoice">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table id="qualificationTable" class="table table-bordered table-striped">
                </table>
              </div>
            </div>
  ...
  <!-- page script -->  
    ...
    <script src="JS_CSS/calificacion/calificacion.js?<%=Session("version") %>"></script>
</body>
