<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ica2.aspx.vb" Inherits="WEB.ica2" %>
...
<head>
  ...
  <!-- Font Awesome -->  <link rel="stylesheet" href="css/font-awesome.min.css?<%=Session("version") %>">
  <!-- Theme style -->
...
<div class="col-md-8">
 ...
 noVisibleListadoSaneamientos = "style='display:none'"
          ...
          %>    
        <li class="menu_alta1 menu_alta2 menu_ica2 menu_alta_fin active" <%=noVisibleAltaGuia%>  >
        <a href="alta1.aspx">
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
           <h1><%= Me.LiteralesPage("53778") %></h1>
        <p><%= Me.LiteralesPage("53779") %></p>
      ...
      <section class="content alta">
        <div class="row">
          <ul class="pasos">
            <li ><%= Me.LiteralesPage("50303") %> 1<span class="pasos_total">/2</span> <span><%= Me.LiteralesPage("53734") %></span></li>
            <li class="activo"><%= Me.LiteralesPage("50303") %> 2 <span><%= Me.LiteralesPage("53740") %></span></li>
          ...
          <form action="" class="form-inline">
            <div class="invoice">
                <div class="row">
                 ...
                 <fieldset>
               <!-- <legend><%=Me.LiteralesPage("53778") %></legend>-->
                <div class="caja_formu">
                   <div class="row">
                        <label>1. </label><%= Me.LiteralesPage("53741") %>:
                       <input id="E1"  runat="server" value="T3,B4,LP,L3"/>                         
                  </div>
                  <div class="row"><br /></div>
                  <div class="row">
                       <label for="si">2. <%= Me.LiteralesPage("53776") %>:</label>
                        <input type="radio" value="1" name="E2" class="" id="RADIOE2SI" runat="server" checked="true">
                        <label for="no"><%= Me.LiteralesPage("53777") %>:</label>
                        <input type="radio" value="0" name="E2" class="" id="RADIOE2NO" runat="server">  
                       <%=Me.LiteralesPage("53742") %> <input id="E21"  runat="server" value=""/>                        
                  </div>
                  <div class="row"><br /></div>
                  <div class="row">
                       <label for="si">3. <%= Me.LiteralesPage("53776") %>:</label>
                        <input type="radio" value="1" name="E3" class="" id="RADIOE3SI" runat="server">
                        <label for="no"><%= Me.LiteralesPage("53777") %>:</label>
                        <input type="radio" value="0" name="E3" class="" id="RADIOE3NO" runat="server"  checked="true">  
                       <%=Me.LiteralesPage("53743") %> <input id="E31"  runat="server" value=""/>                                                                         
                  </div>
                  <div class="row"><br /></div>
                  <div class="row">
                       <label ><%= Me.LiteralesPage("53744") %>:</label>
                                              
                  </div>
                  <div class="row"><br /></div>
          
                  <div class="row">
                       <label for="si">4. <%= Me.LiteralesPage("53776") %>:</label>
                        <input type="radio" value="1" name="E4" class="" id="RADIOE4SI" runat="server" >
                        <label for="no"><%= Me.LiteralesPage("53777") %>:</label>
                        <input type="radio" value="0" name="E4" class="" id="RADIOE4NO" runat="server" checked="true">  
                       <%=Me.LiteralesPage("53745") %>                                                 
                  </div>
                  <div class="row"><br /></div>
                  <div class="row">
                          <table style="margin-left:5%" id="tablaE4"  class="table table-bordered table-striped">
                              <tr>
                                  <th> <%=Me.LiteralesPage("53747") %></th>
                                  <th> <%=Me.LiteralesPage("53748") %>  </th>
                                
                              </tr>
                               <tr>
                                  <td> <input  id="E411"  runat="server" > </td>
                                  <td><input  id="E412"   runat="server"> </td>
                                
                              </tr>
                              <tr>
                                  <td> <input id="E421"  runat="server" > </td>
                                  <td><input id="E422"  runat="server" > </td>
                  ...
                  <div class="row"><br /></div>
                  <div class="row">
                       <label for="si">5. <%= Me.LiteralesPage("53776") %>:</label>
                        <input type="radio" value="1" name="E5" class="" id="RADIOE5SI" runat="server" >
                        <label for="no"><%= Me.LiteralesPage("53777") %>:</label>
                        <input type="radio" value="0" name="E5" class="" id="RADIOE5NO" runat="server" checked="true">  
                       <%=Me.LiteralesPage("53746") %>
                                                                       
                  </div>
                       <div class="row"><br /></div>
                  <div class="row">
                             <table style="margin-left:5%" id="tablaE5"  class="table table-bordered table-striped">
                              <tr>
                                  <th> <%=Me.LiteralesPage("53747") %></th>
                                  <th> <%=Me.LiteralesPage("53748") %>  </th>
                               ...
                               <tr>
                                  <td> <input  id="E511"  runat="server" > </td>
                                  <td><input  id="E512"   runat="server"> </td>
                                
                              </tr>
                              <tr>
                                  <td> <input id="E521"  runat="server" > </td>
                                  <td><input id="E522"  runat="server" > </td>
                  ...
                  <div class="row"><br /></div> 
                  <div class="row">
                       <label for="si">6. <%= Me.LiteralesPage("53776") %>:</label>
                        <input type="radio" value="1" name="E6" class="" id="RADIOE6SI" runat="server" >
                        <label for="no"><%= Me.LiteralesPage("53777") %>:</label>
                        <input type="radio" value="0" name="E6" class="" id="RADIOE6NO" runat="server" checked="true">  
                       <%=Me.LiteralesPage("53749") %>    
                       <input id="E61"  runat="server" value=""/>                                              
                  </div>
                  <div class="row"><br /></div>    
                  <div class="row">
                       <label for="si">7. <%= Me.LiteralesPage("53776") %>:</label>
                        <input type="radio" value="1" name="E7" class="" id="RADIOE7SI" runat="server" >
                        <label for="no"><%= Me.LiteralesPage("53777") %>:</label>
                        <input type="radio" value="0" name="E7" class="" id="RADIOE7NO" runat="server" checked="true">  
                       <%=Me.LiteralesPage("53750") %>   
                      <input id="E71"  runat="server" value=""/>                                                                                            
                  </div>
                  <div class="row"><br /></div>  
                      <div class="row">
                        <label for="si">8.</label><%=Me.LiteralesPage("53751") %> 
                          <table id="tablaE8"  class="table table-bordered table-striped">
                              <tr>
                                  <td> <input type="checkbox" id="E81" value="second_checkbox" runat="server"><%=Me.LiteralesPage("53752") %> </td>
                                  <td> <input type="checkbox" id="E82" value="second_checkbox" runat="server"><%=Me.LiteralesPage("53756") %></td>
                                  <td> <input type="checkbox" id="E83" value="second_checkbox" runat="server"><%=Me.LiteralesPage("53760") %></td>
                              </tr>
                              <tr>
                                  <td> <input type="checkbox" id="E84" value="second_checkbox" runat="server"><%=Me.LiteralesPage("53753") %></td>
                                  <td> <input type="checkbox" id="E85" value="second_checkbox" runat="server"><%=Me.LiteralesPage("53757") %></td>
                                  <td> <input type="checkbox" id="E86" value="second_checkbox" runat="server"><%=Me.LiteralesPage("53761") %></td>
                              </tr>
                              <tr>
                                  <td> <input type="checkbox" id="E87" value="second_checkbox" runat="server"><%=Me.LiteralesPage("53754") %></td>
                                  <td> <input type="checkbox" id="E88" value="second_checkbox" runat="server"><%=Me.LiteralesPage("53758") %></td>
                              </tr>
                              <tr>
                                  <td> <input type="checkbox" id="E89" value="second_checkbox" runat="server"><%=Me.LiteralesPage("53755") %></td>
                                  <td> <input type="checkbox" id="E810" value="second_checkbox" runat="server"><%=Me.LiteralesPage("53759") %>></td>
                                  <td></td>
                              </tr>
                  ...
                  <div class="row"><br /></div> 
                  <div class="row">                      
                      <label for="si"> 9.</label><%=Me.LiteralesPage("53762") %>   <input type="text" id="E9" value="" runat="server">                                              
                  </div>
                  <div class="row"><br /></div> 
                  <div class="row">
                      <label for="si">10.</label><%=Me.LiteralesPage("53763") %>  
                      <table id="tablaE10" class="table table-bordered table-striped">
                          <tr>
                              <td> <input type="checkbox" id="E101" value="second_checkbox" runat="server"></td>
                              <td><%=Me.LiteralesPage("53764") %></td>
                          </tr>
                            <tr>
                              <td> <input type="checkbox" id="E102" value="second_checkbox" runat="server"></td>
                              <td><%=Me.LiteralesPage("53765") %></td>
                          </tr>
                            <tr>
                              <td> <input type="checkbox" id="E103" value="second_checkbox" runat="server"></td>
                              <td><%=Me.LiteralesPage("53766") %></td>
                          </tr>
                            <tr>
                              <td> <input type="checkbox" id="E104" value="second_checkbox" runat="server"></td>
                              <td><%=Me.LiteralesPage("53767") %></td>
                          </tr>
                      </table>                                               
                  </div>
               </div>
             ...
             <div class="botonera">
             <a id="btnPasoAnterior" href="ica1.aspx" class="pull-left"><%= Me.LiteralesPage("50520") %></a> 
             <a id="btnFinalizar" href="alta3.aspx" class="pull-right"><%= Me.LiteralesPage("50519") %></a>
  ...
  <script src="JS_CSS/jquery-2.2.3.min.js?<%=Session("version") %>"></script>
    ...
    <script src="JS_CSS/ica2/ica2.js?<%=Session("version") %>"></script>
