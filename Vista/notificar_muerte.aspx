<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="notificar_muerte.aspx.vb" Inherits="WEB.notificar_muerte" %>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                <div class="user-panel">
                    <div id="divBadge" class="notification-badge fase2"><%=Session("ves") %></div>
       ...
       <%--Alta y baja de animales--%>
         ...
         <li class="treeview fase2 active" <%=noVisibleSubMenuAltaBaja%>>
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="notificar_muerte.aspx" <%=noVisibleNotificarMuerte%>><i class="fa fa-circle-o"></i><%= Me.Literales("50033") %></a></li>
              ...
              <li><a href="confirma_guia_entrada.aspx"><i class="fa fa-circle-o" <%=noVisibleConfirmarGuias%>></i><%= Me.Literales("50041") %></a></li>
            </ul>
          </li>
...
<%--Consulta datos --%>
        ...
        <ul class="treeview-menu">
            ...
            <li class="menu_registro"><a href="registro.aspx" <%=noVisibleLibroRegistro%>><i class="fa fa-circle-o"></i><%= Me.Literales("Notificaciones") %></a></li>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
        ...
        <ul class="treeview-menu">
            <li class="menu_explotacion"><a href="explotacion.aspx" <%=noVisibleDatos%>><i class="fa fa-circle-o"></i><%= Me.Literales("50001") %></a></li>
       ...
       %>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><%= Me.LiteralesPage("52901") %></h1>
                <p><%= Me.LiteralesPage("52902") %></p>
            </section>
          ...
          <form action="" class="form-inline" id="notificarMuerteForm">
            <div class="invoice">
                <div class="row">
                    <ul id="messageBox"></ul>
                </div>
                <div id="myModal" class="modal fade bs-example-modal-sm in" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                ...
                <div class="formu_nacimiento">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="fecha_notificacion"><%= Me.LiteralesPage("52903") %>:</label>
                          <input class="form-control" id="fecha_notificacion" value="" readonly="" type="text">
                      </div>
                    </div>

                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="explotacion"><%= Me.LiteralesPage("52904") %>:</label>
                        <input class="form-control" id="explotacion" value="<%= Session("ExplotacionSeleccionada").explotacion %>" readonly="" type="text">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="crotal_muerte"><%= Me.LiteralesPage("52905") %>:(X)</label>
                        <input type="text" class="form-control" id="crotal_muerte" name="crotal_muerte" placeholder=""">
                      </div>
                    </div>
                     
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="nombre_muerte"><%= Me.LiteralesPage("52906") %>:</label>
                        <input type="text" class="form-control" id="nombre_muerte" name="nombre_muerte" placeholder="">
                      </div>
                    </div>
                     
                  </div>

                <div id="muerteTable" class="poplg">
                    <table id="tabla-muerte" class="table table-responsive tablepop">                    
                </table>
                 </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="fecha_muerte"><%= Me.LiteralesPage("52907") %>:(X)</label>
                        <div class="input-group date"">
                          <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                          </div>
                          <input type="text" class="form-control pull-right" id="fecha_muerte" name="fecha_muerte" value="">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12 col-lg-12">
                      <div class="form-group">
                        <label for="observaciones" style="vertical-align: top;"><%= Me.LiteralesPage("52908") %>:</label>
                        <textarea class="form-control" rows="5" id="observaciones" name="observaciones" maxlength="150"></textarea>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div id="recogida" runat="server">
                        <input type="checkbox" class="" id="recogidaGanadoBiltzen" >
                        <label for="recogidaGanadoBiltzen"><%= Me.LiteralesPage("53783") %></label>
                        </div>
                    </div>
                  </div>
         
               <%
                dim noActivoNotificarMuerte=""
                  Dim mensaje=""
                        ...
                        if System.Web.HttpContext.Current.Session("SelectedLanguage") ="es" then
                         ...
                         If (Now<fechafin) and (Now>fechaini) Then
                           noActivoNotificarMuerte ="style='display:none'"
                         End If         
                        
               %>
                  
              <div class="row text-center row-query-buttons" <%=noActivoNotificarMuerte%>>
                <button type="submit"   id="sendForm" class="btn btn-default"><%= Me.LiteralesPage("52909") %></button>
              </div>
                       <% 
            ...
            <%--MSG OK - QUITAR TODO LO DEMAS--%>
            <div id="msg-ok" class="solicitud-crotales-form" style="display: none;">
                <div class="col-md-12 solicitud-ok">
                    <p class="texto4ok"></p>
                </div>
            </div>
        </div>
    ...
    <script src="../recursos/AdminLTEv2/plugins/datatables/dataTables.bootstrap.min.js?<%=Session("50036") %>"></script>
    <script src="../recursos/AdminLTEv2/plugins/sparkline/jquery.sparkline.min.js?<%=Session("50029") %>"></script>
    <script src="../recursos/AdminLTEv2/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js?<%=Session("50030") %>"></script>
    <script src="../recursos/AdminLTEv2/plugins/jvectormap/jquery-jvectormap-world-mill-en.js?<%=Session("50031") %>"></script>
    ...
    <script src="JS_CSS/notificar_muerte/notificar_muerte.js?<%=Session("50037")%>"></script>
