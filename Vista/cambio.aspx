<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="cambio.aspx.vb" Inherits="WEB.cambio" %>
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("51161") %></h1>
          <p><%= Me.LiteralesPage("51162") %></p>
      </section>
      ...
      <section class="content alta">
        <div class="row">
          <div class="actual">
            <p><%= Me.LiteralesPage("51162") %></p>
            <p id="numero_exp" class="numero_exp" runat="server"></p>
          </div>
        </div>
        <div class="row">
          <div class="invoice">
        ...
        <div class="box-body">
              <div class="table-responsive">
                <table id="cambioTable" class="table table-bordered table-striped">
                </table>
              </div>
            </div>
          </div>
  ...
  <script src="JS_CSS/jquery-2.2.3.min.js?<%=Session("version") %>"></script>
    ...
    <script>
        ...
        var selectedExploitationID = '<%= NEKAGIP.SessionNekagip.ExplotacionSeleccionada.explotacion %>';
        var selectedExploitationDescription = '<%= NEKAGIP.SessionNekagip.ExplotacionSeleccionada.denominacion %>';
    ...
    <script src="JS_CSS/cambio/cambio.js?<%=Session("version") %>"></script>
