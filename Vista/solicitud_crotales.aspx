<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="solicitud_crotales.aspx.vb" Inherits="WEB.solicitud_crotales" %>
        ...
        <a href="inicio.aspx">
         ...
         <li class="treeview fase2 active" <%=noVisibleGestioCrotales%>>
              ...
              <ul class="treeview-menu">
                 ...
                 <li <%=noVisibleSolicitudCrotales%> class="active"><a href="solicitud_crotales.aspx"><i class="fa fa-circle-o"></i><%= Me.Literales("50030") %></a></li>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
       ...
       %>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><%= Me.LiteralesPage("52001") %></h1>
                <p><%= Me.LiteralesPage("52002") %></p>
            ...
            <section class="content alta">
                ...
                <div class="row">
                    <div class="invoice solicitud-crotales">
                        <div class="header-solicitud-crotales">
                            <div class="solicitud-head-icon"><i class="fa fa-tags"></i></div>
                            <div class="solicitud-head-text">
                                <p><%= Me.LiteralesPage("52003") %>: <span><%= Me.LiteralesPage("52004") %></span></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="condiciones col-md-10 col-md-offset-1">
                                <ul>
                                    <li><%= Me.LiteralesPage("52005") %></li>
                                    <li><%= Me.LiteralesPage("52006") %></li>
                                </ul>
                            </div>

                            <form class="solicitud-crotales-form">
                                <div class="row">
                                    <ul id="messageBox"></ul>
                                </div>
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1 separa_lineas">
                                        <div action="" class="form-inline">
                                            <fieldset>
                                                <label for="fecha_muerte"><%= Me.LiteralesPage("52007") %>:</label>
                                                <div class="input-group date">
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-calendar"></i>
                                                    </div>
                                                    <input type="text" class="form-control pull-right parafecha"  name="fecha_solicitud" id="fecha_solicitud">
                                                </div>
                                            </fieldset>
                                        </div>
                                    </div>
                                    <div class="col-md-10 col-md-offset-1">
                                        <div class="form-group">
                                            <label for="num_crotales"><%= Me.LiteralesPage("52008") %>:</label>
                                            <input name="num_crotales" type="text" class="form-control" placeholder="" id="num_crotales" value="0" runat="server">

                                            <label for="tenazas"><%= Me.LiteralesPage("52009") %>:</label>
                                            <input name="tenazas" type="checkbox" id="incluir_tenazas" value="" runat="server">
                                        </div>
                                    </div>
                                </div>
                                <div class="row text-center">
                                    <button  type="submit" id="btnSolicitarCrotales"><%= Me.LiteralesPage("52010") %></button>
                                </div>
                            ...
                            <div id="msg-ok" class="solicitud-crotales-form" style="display: none;">
                                <div class="col-md-12 solicitud-ok">
									<p class="texto4ok"><%= Me.LiteralesPage("52011") %></p>                                
                                </div>
                            </div>

                            <%--MSG ERROR JUSTO DEBAJO DEL BOTON--%>
                            <div id="msg-error" class="solicitud-crotales-form" style="display: none;">
                                <div class="col-md-12 solicitud-error">
                                    <p class="texto4error"><%= Me.LiteralesPage("52012") %></p>
                                </div>
                            </div>
    ...
    <script src="JS_CSS/solicitud_crotales/solicitud_crotales.js?<%=Session("version") %>"></script>
</body>
</html>
