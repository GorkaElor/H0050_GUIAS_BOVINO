<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="confirmacion_de_guias.aspx.vb" Inherits="WEB.confirmacion_de_guias" %>
...
<%--Consulta datos --%>
   ...
   Dim noVisibleSeguimiento = ""
       ...
       %>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><%= Me.LiteralesPage("53201") %></h1>
                <p><%= Me.LiteralesPage("53202") %></p>
            </section>
        ...
        <div class="row">
          ...
          <div class="invoice guia">

           
              <div class="col-xs-12">
                <button id="volver" class="btn btn-default botguia" title="Volver"><!--<i class="fa fa-chevron-left"></i>--> <%= Me.LiteralesPage("53203") %></button>
                <h2 class="h2guia"><%= Me.LiteralesPage("53204") %><small class="pull-right ult_acc"><i id="estado_icono"></i> <span id="estado"></span></small> </h2>
              </div>
            
            <div class="row">
              <div class="col-md-5 col-md-offset-1 detalle"><%= Me.LiteralesPage("53205") %>: <span id="fecha_entrada"></span></div>
              <div class="col-md-5 col-md-offset-1 detalle"><%= Me.LiteralesPage("53206") %>: <span id="num_guia"></span></div>
            </div>
            <div class="row">
              <div class="col-md-5 col-md-offset-1 detalle"><%= Me.LiteralesPage("53207") %>: <span id="expl_origen"></span></div>
              <div class="col-md-5 col-md-offset-1 detalle"><%= Me.LiteralesPage("53208") %>: <span id="num_crotales"></span></div>
            </div>
         

          <h3 class="h3guia"><%= Me.LiteralesPage("53209") %></h3>
            ...
            <div class="box-body">
              ...
              <div><strong id="txt_descripcion"></strong></div>
            <div class="row">
                <ul id="messageBox"></ul>
            </div>
            <div class="row text-center" id="botonera">
                <button id="aceptar"  class="btn btn-default icono grande"><i class="fa fa-check"></i> <%= Me.LiteralesPage("53210") %></button>
                <button id="rechazar" class="btn btn-default icono remove-button grande"><i class="fa fa-times"></i> <%= Me.LiteralesPage("53211") %></button>
            </div>
    ...
    <script src="JS_CSS/confirmacion_de_guias/confirmacion_de_guias.js?<%=Session("version") %>"></script>
</body>
