<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="crotales_disponibles.aspx.vb" Inherits="WEB.crotales_disponibles" %>
              ...
              <ul class="treeview-menu">
                   <%      
                    ...
                    End If
                     ...
                     End If
                 %>
                 <li class="active" <%=noVisibleCrotalesDisponibles%>><a href="crotales_disponibles.aspx"><i class="fa fa-circle-o"></i><%= Me.Literales("50029") %></a></li>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="row">
            <!--filtro de listado perdidas -->
           <div class="invoice form-inline">
               <div>
               <div class="form-group">
                      <label class="ancho80"><%= Me.LiteralesPage("52506") %>:</label>
                      <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right" id="fecha_desde">
                         ...
                         <label class="ancho80"><%= Me.LiteralesPage("52507") %>:</label>
                      <div class="input-group date">
                        <div class="input-group-addon">
                          <i class="fa fa-calendar"></i>
                        </div>
                        <input type="text" class="form-control pull-right" id="fecha_hasta">
                      </div>       
                    </div>     
                    <div class="botones_perdida"><button class="boton_listadoPerdida" onclick ="imprimirListadoPerdida('<%= explotationCodigo() %>')"><i class="fa fa-print"></i><%= Me.LiteralesPage("53713") %></button>
             ...
             <!--filtro de listado perdidas -->
        <!--  <div class="invoice"> <div class="botones_perdida"><button class="boton_listadoPerdida" onclick ="imprimirListadoPerdida('pdf')"><i class="fa fa-print"></i>Listado pérdida</button></div>-->
                 
            <div class="box-body">

                <div class="table-responsive">
                      <table id="table-crotales" class="table table-bordered table-striped">                
                    </table>
                </div>   
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <%= Me.LiteralesPage("52702") %> 
                        </div>
                        <div class="modal-body">
                            <input type="hidden" name="guia" id="guia" value=""/>
                            <span id="message"<%= Me.LiteralesPage("52703") %>></span>
                        </div>
                        <div class="modal-footer">
                            <a class="btn btn-success btn-ok"><%= Me.LiteralesPage("52704") %></a> <%--Aceptar--%>
                        </div>
                    </div>
                </div>
                </div>
 ...
 <!-- jQuery 2.2.3 -->
  <script src="JS_CSS/jquery-2.2.3.min.js?<%=Session("version") %>"></script>
    ...
    <script src="JS_CSS/crotales_disponibles/crotales_disponibles.js?<%=Session("version") %>"></script>
