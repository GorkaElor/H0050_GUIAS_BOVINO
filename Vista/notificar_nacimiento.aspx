<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="notificar_nacimiento.aspx.vb" Inherits="WEB.notificar_nacimiento" %>
...
<body class="hold-transition sidebar-mini <%= sideBarStatusCollapsed() %> background">
    ...
    <span class="logo-mini"><img src="img/logo_nekagip_mini_priv.png" alt="Nekagip"> </span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><img src="img/logo_nekagip.png" alt="Nekagip"> </span>
    </a>
...
<div class="area_privada col-md-4"> <i class="fa fa-lock"></i>
        ...
        <%--Gestión de crotales--%>
         ...
         <li class="treeview fase2" <%=noVisibleGestioCrotales%>>
              ...
              <ul class="treeview-menu">
                   <p id="prueba50">TIENE QUE APARECER UN 50</p>
                     <%      
         ...
         <%
             ...
             End If
          %>   
         <li class="treeview fase2 active" <%=noVisibleSubMenuAltaBaja%>>
            <a href="#">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="notificar_nacimiento.aspx" <%=noVisibleNotificarNacimiento%>><i class="fa fa-circle-o"></i><%= Me.Literales("50032") %></a></li>
              <li><a href="notificar_muerte.aspx" <%=noVisibleSubMenuAltaBaja%>><i class="fa fa-circle-o"></i><%= Me.Literales("50033") %></a></li>
...
Dim noVisibleMontesAutorizados=""
    ...
    <div class="content-wrapper">
      ...
      <section class="content alta">
       <div class="row">
          ...
          <form class="form-inline" id="notificar_nacimiento" name="notificar_nacimiento"  method="post">
            <div class="invoice disable-box">
                <div class="row">
                    <ul id="messageBox"></ul>
                </div>
              <fieldset>
                <legend><%= Me.LiteralesPage("52802") %></legend>
                <div class="formu_nacimiento">
                  
                  <div class="row">

                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="nombre_animal" class="over_label"><%= Me.LiteralesPage("52803") %>:</label>
                        <input type="text" class="form-control" id="nombre_animal" placeholder="" name="nombre_animal">
                      </div>
                    </div>

                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="raza_animal" class="over_label"><%= Me.LiteralesPage("52804") %>:(X)</label>
                        <select name="raza" aria-controls="raza" class="form-control input-md" runat="server" id="raza">
                    ...
                    <div class="col-md-5">
                      <div class="form-group">
                        <label for="sexo_animal" class="over_label"><%= Me.LiteralesPage("52805") %>:(X)</label>
                        <select name="sexo" aria-controls="sexo" class="form-control input-md" runat="server" id="sexo">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="peso_animal" class="over_label"><%= Me.LiteralesPage("52806") %>:</label>
                        <input class="form-control" id="peso_animal" placeholder="" name="peso_animal">
                      </div>
                    </div>

                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="aptitud_animal" class="over_label"><%= Me.LiteralesPage("52807") %>:(X)</label>
                        <select name="aptitud" aria-controls="aptitud" class="form-control input-md" runat="server" id="aptitud">
                    ...
                    <div class="col-md-5">
                      <div class="form-group">
                        <label for="registro_genealogico" class="over_label"><%= Me.LiteralesPage("52808") %>:</label>
                        <input type="text" class="form-control" id="registro_genealogico" placeholder="" value="" name="registro_genealogico">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="tipo_parto" class="over_label"><%= Me.LiteralesPage("52809") %>:</label>
                        <select name="tipoParto" aria-controls="tipo" class="form-control input-md" id="tipoParto" runat="server">
                  ...
                  <div class="row"> <div class="col-md-3">
                      <div class="form-group">
                        <label for="sexo_animal" class="over_label"><%= Me.LiteralesPage("52810") %>:</label>
                        <select name="facilidadParto" aria-controls="sexo" class="form-control input-md" runat="server" id="facilidadParto">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="tipo_inseminacion" class="over_label"><%= Me.LiteralesPage("52811") %>:</label>
                        <select name="inseminacion" aria-controls="inseminacion" class="form-control input-md"  id="inseminacion" runat="server">
                    ...
                    <div class="col-md-5">
                      <div class="form-group">
                        <label for="fecha_animal"  class="over_label"><%= Me.LiteralesPage("52814") %>:(X)</label>
                  ...
                  <div class="row">                  
                    ...
                    <div class="col-md-12 doble">
                      <div class="form-group">
                        <label for="madre_animal" class="over_label"><%= Me.LiteralesPage("52815") %>:(X)</label>
                        <input type="text" class="form-control" id="madre_crotal" placeholder="<%= Me.LiteralesPage("52820") %>" name="madre_crotal">
                        <input type="text" class="form-control" id="madre_nombre" placeholder="<%= Me.LiteralesPage("52803") %>">
                        <button type="button" id="btnDeleteMadre" class="btn btn-default btn-formu"><i class="fa fa-eraser"></i><%= Me.LiteralesPage("52816") %></button>
                      </div>
                    </div>

                  </div>

                <div id="madreTable" class="poplg">
                    <table id="tabla-madre" class="table table-responsive tablepop">                    
                    </table>
                 </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 doble">
                      <div class="form-group">
                        <label for="madreet_animal" class="over_label"><%= Me.LiteralesPage("52817") %>:</label>
                        <input type="text" class="form-control" id="madreET_crotal" placeholder="<%= Me.LiteralesPage("52820") %>" name="madreET_crotal">
                        <input type="text" class="form-control" id="madreET_nombre" placeholder="<%= Me.LiteralesPage("52803") %>">
                        <button type="button" id="btnDeleteMadreET" class="btn btn-default btn-formu"><i class="fa fa-eraser"></i><%= Me.LiteralesPage("52816") %></button>
                      </div>
                    </div>
                    
                  </div>
                  
                 <div id="madreETTable" class="poplg">
                    <table id="tabla-madreET" class="table table-responsive tablepop">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 doble">
                      <div class="form-group">
                        <label for="padre_animal" class="over_label"><%= Me.LiteralesPage("52818") %>:</label>
                        <input type="text" class="form-control" id="padre_crotal" placeholder="<%= Me.LiteralesPage("52820") %>" name="padre_crotal">
                        <input type="text" class="form-control" id="padre_nombre" placeholder="<%= Me.LiteralesPage("52803") %>">
                        <button type="button" id="btnDeletePadre" class="btn btn-default btn-formu"><i class="fa fa-eraser"></i><%= Me.LiteralesPage("52816") %></button>
                      </div>
                    </div>
                    
                  </div>

                <div id="padreTable" class="poplg">
                    <table id="tabla-padre" class="table table-responsive tablepop">
              ...
              <fieldset>
                <legend><%= Me.LiteralesPage("52819") %></legend>
                <div class="formu_nacimiento">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="crotal_animal"  class="over_label"><%= Me.LiteralesPage("52820") %>:(X)</label>
                        <input type="text" class="form-control" id="crotal_animal" name="crotal_animal" >
                      </div>
                    </div>

                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="impl_animal"  class="over_label"><%= Me.LiteralesPage("52821") %>:(X)</label>
                        <div class="input-group date">
                          <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                          </div>
                          <input type="text" class="form-control pull-right" id="impl_animal" name="impl_animal">
                        </div>
                ...
                <div id="nombre_2" class="popxs">
                    <table id="tabla-crotales-sin-asignar" class="table table-responsive tablepop">
                    
                    </table>
                </div>
              </fieldset>

              <div class="perdida-buttons">
                   <button  id="btnNotificarNacimiento" class="btn btn-default icono"><%= Me.LiteralesPage("52822") %></button>
               
              </div>
            </div>

             <%--alert modal para mostrar cuando es una explotacion de control de  rendimiento que tiene datos sin rellenar--%>
            <div class="modal fade" id="alert-confirmacion-continuar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                           <%= Me.LiteralesPage("52823") %>
                        </div>
                        <div class="modal-body">
                            <input type="hidden" name="guia" id="guia" value=""/>
                            <span id="message"><%= Me.LiteralesPage("53782")%></span>
                        </div>
                        <div class="modal-footer">
                            <a id="btnSi" class="btn btn-success btn-ok"><%= Me.LiteralesPage("52825") %></a> <%--Aceptar--%>
                            <a id="btnNo" class="btn btn-success btn-Nook"><%= Me.LiteralesPage("53415") %></a> <%--Cancelar--%>
                        </div>
                    </div>
                </div>
                </div>

               <%--alert modal para mostrar que no seleccionó crotales--%>
            <div class="modal fade" id="alert-confirmacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                           <%= Me.LiteralesPage("52823") %>
                        ...
                        <div class="modal-body">
                            <input type="hidden" name="guia" id="guia" value=""/>
                            <span id="message"><%= Me.LiteralesPage("52824") %></span>
                        </div>
                        <div class="modal-footer">
                            <a id="btnYes" class="btn btn-success btn-ok"><%= Me.LiteralesPage("52825") %></a> <%--Aceptar--%>
                        </div>
                    </div>
                </div>
                </div>
 ...
 <!-- jQuery 2.2.3 -->
  <script src="JS_CSS/jquery-2.2.3.min.js?<%=Session("version") %>"></script>
    ...
    <script src="JS_CSS/jquery-number-2.1.6/jquery.number.min.js?<%=Session("version") %>"></script>
    <!-- page script -->
    ...
    <script src="JS_CSS/notificar_nacimiento/notificar_nacimiento.js?<%=Session("version") %>"></script>
