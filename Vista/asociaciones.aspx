<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="asociaciones.aspx.vb" Inherits="WEB.asociaciones" %>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
        ...
        <ul class="treeview-menu">
            ...
            <li class="menu_asociaciones active"><a href="asociaciones.aspx" <%=noVisibleAsociaciones%>><i class="fa fa-circle-o"></i><%= Me.Literales("50014") %></a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("51131") %></h1>
        <p><%= Me.LiteralesPage("51133") %></p>
      </section>
  ...
  <!-- page script -->       
    ...
    <script src="JS_CSS/asociaciones/asociaciones.js?<%=Session("version") %>"></script>
</body>
