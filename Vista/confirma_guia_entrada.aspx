<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="confirma_guia_entrada.aspx.vb" Inherits="WEB.confirma_guia_de_entrada" %>
        ...
        <a href="inicio.aspx">
         ...
         <li class="treeview fase2 active" <%=noVisibleSubMenuAltaBaja%>>
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="confirma_guia_entrada.aspx" <%=noVisibleConfirmarGuias%>><i class="fa fa-circle-o"></i><%= Me.Literales("50041") %></a></li>
            </ul>
          </li>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
       ...
       %>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><%= Me.LiteralesPage("53301") %></h1>
                <p><%= Me.LiteralesPage("53302") %></p>
            </section>
            ...
            <section class="content">
                 ...
                 <form action="" class="form-inline">
                    ...
                    <div class="formu_nacimiento">
                        <div class="form-group">
                          <label for="crotal" class="guia"><%= Me.LiteralesPage("53303") %>:</label>
                          <input type="text" class="form-control input-sm" id="crotal" placeholder="">
                          <button class="btn btn-default icono buscar" title="Busca" onclick="javascript:buscar(); return false;"><i class="fa fa-search"></i>  <%= Me.LiteralesPage("53304") %></button>
                        </div>
                    </div>
                 </form>
                  ...
                  <div class="invoice disable-box">
                    <div class="box-body">
                         <input type="hidden" id="esMatadero" value="<%=NEKAGIP.SessionNekagip.ExplotacionSeleccionada.matadero%>">
                 
                         <div class="table-responsive">
                            <table id="table-guias-entrada" class="table table-bordered table-striped">                
                            </table>
                        </div>  
                  </div>
                      
                <%--Confirm modal para anular una guía--%>
                <div class="modal fade" id="confirm-anular" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <%= Me.LiteralesPage("50807") %> <%--Confirmación de anulación de guía--%>
                            </div>
                            <div class="modal-body">
                                <input type="hidden" name="guia" id="guia" value=""/>
                                <%= Me.LiteralesPage("50808") %> <%--¿Está seguro de anular esta guía?--%>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal"><%= Me.LiteralesPage("50810") %></button> <%--Cancelar--%>
                                <a class="btn btn-success btn-ok"><%= Me.LiteralesPage("50809").ToString.ToUpper() %></a> <%--Aceptar--%>
                            </div>
                        </div>
                    </div>
                 </div>
                ...
                <div class="modal fade" id="alert-confirmacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <span id="cabecera"><%= Me.LiteralesPage("53305") %></span>
                            </div>
                            <div class="modal-body">
                                <input type="hidden" name="guia" id="guia" value=""/>
                                <%= Me.LiteralesPage("53306") %>
                            </div>
                            <div class="modal-footer">
                                <a class="btn btn-success btn-ok"><%= Me.LiteralesPage("53307") %></a> <%--Aceptar--%>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
      ...
      var permisoAnularGuia = '<%=NEKAGIP.SessionNekagip.PermisosData.lista.Contains("ANULAR_GUIA_ENTRADA")%>';
      var esexplotacionpropia='<%=Not NEKAGIP.SessionNekagip.ExplotacionSeleccionada Is Nothing AndAlso NEKAGIP.SessionNekagip.ExplotacionSeleccionada.propia = "true"%>'
            var permisoDIB = '<%=NEKAGIP.SessionNekagip.PermisosData.lista.Contains("IMP_DIB_GUIAENTRADA")%>';
    ...
    <script src="JS_CSS/confirma_guia_entrada/confirma_guia_entrada.js?<%=Session("version") %>"></script>
</body>
