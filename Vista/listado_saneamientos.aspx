<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="listado_saneamientos.aspx.vb" Inherits="WEB.listado_saneamientos" %>
       ...
       <ul class="sidebar-menu">
        ...
        <%
         ...
         <%
             ...
             End If
          %>     
         <li class="treeview fase2  active" <%=noVisibleSubMenuSaneamientos%>>
            <a href="#">
            ...
            <ul class="treeview-menu">
                ...
                End If
                 ...
                 %>
              <li class="active"><a href="listado_saneamientos.aspx" <%=noVisibleListadoSaneamientos%>><i class="fa fa-circle-o"></i><%= Me.Literales("53843") %></a></li>
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("53843") %></h1>
        <p><%= Me.LiteralesPage("53844") %></p>
      </section>
          ...
          <div class="invoice">              
           ...
           <%-- <div id="myModal" class="modal fade bs-example-modal-sm in" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
               ...
               <div id="izquierda" style="width:100%; text-align: left;" class="table-responsive">  
                            <p><%= Me.LiteralesPage("53848") %>:</p>
                            <button class="btn btn-default boton_movil" onclick="getAssociatedFileSub('pdf')"><i class="fa fa-file-pdf-o"></i><%= Me.LiteralesPage("50904") %></button>
                            <button class="btn btn-default boton_movil" onclick="getAssociatedFileSub('excel')"><i class="fa fa-file-excel-o"></i><%= Me.LiteralesPage("50905") %></button>

                        </div>
              <div class="table-responsive"></div>
             
              <!--ventana emergente para editar  tuberculosis-->
               <div id="myModal" style="display:none" class="modal fade bs-example-modal-sm in" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                             <div class="row">
                                <ul id="messageBox"></ul>
                            ...
                            <div class="row" style="display:none">
                                ...
                                <%--    <label><%=  Me.LiteralesPage("53846")%>:</label> --%>
                                   <input name="SANFECPRU" id="SANFECPRU"></input>
                                      <input name="crotal" id="crotal"></input>
                                  </div>
                            </div>
                            ...
                            <div class="row">
                                  <div class="form-group col-md-12">
                                  <%--  <label>DO:</label>
                                    <input name="DOL" id="DOL">
                              
                                    </input>--%>
                                   <label for="DOL" class="" ><%= "DO" %>:</label>
                                   <select name="DOL" aria-controls="DOL" class="form-control input-md" style="display:inline;font-size:20px;width:30%" id="DOL" runat="server"></select>
                            ...
                            <div class="row">
                                  <div class="form-group col-md-12">
                                   <%-- <label>C:</label>
                                    <input name="C" id="C">
                                        ...
                                        <label for="CAL" class=""><%= "C" %>:</label>
                                   <select name="CAL" aria-controls="CAL" class="form-control input-md" style="display:inline;font-size:20px;width:30%" id="CAL" runat="server"></select>
                              ...
                              <div class="row">
                                 ...
                                 <button id="btnGuardar" class="btn btn-default"><i class="fa fa-pencil"></i><%=  Me.LiteralesPage("53416") %></button>
  ...
  <script src="JS_CSS/jquery-2.2.3.min.js?<%=Session("version") %>"></script>
    ...
    <script src="JS_CSS/listado_saneamientos/listado_saneamientos.js?<%=Session("version") %>"></script>
