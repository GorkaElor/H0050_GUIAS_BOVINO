<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="titulares.aspx.vb" Inherits="WEB.titulares" %>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
        ...
        <ul class="treeview-menu">
            ...
            <li class="menu_titulares active"><a href="titulares.aspx" <%=noVisibleTitulares%>><i class="fa fa-circle-o"></i><%= Me.Literales("50013") %></a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("51121") %></h1>
        <p><%= Me.LiteralesPage("51125") %></p>
      </section>
          ...
          <div class="invoice">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table id="titularesTable" class="table table-bordered table-striped">
                </table>
              </div>
            </div>
  ...
  <!-- page script -->  
    ...
    <script src="JS_CSS/titulares/titulares.js?<%=Session("version") %>"></script>
</body>
