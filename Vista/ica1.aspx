<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ica1.aspx.vb" Inherits="WEB.ica1" %>
...
<div class="col-md-8">
 ...
 noVisibleListadoSaneamientos = "style='display:none'"
          ...
          %>       
        <li class="menu_ica1 menu_alta2 menu_alta3 menu_alta_fin active" <%=noVisibleAltaGuia%>  >
        <a href="ica1.aspx">
...
<%--Consulta datos --%>
   ...
   Dim noVisibleSeguimiento = ""
    ...
    <div class="content-wrapper">
      ...
      <!-- Main content -->
        ...
        <div class="row">
          <ul class="pasos">
            <li class="activo"><%= Me.LiteralesPage("50303") %> 1<span class="pasos_total">/2</span> <span><%= Me.LiteralesPage("53734") %></span></li>
            <li><%= Me.LiteralesPage("50303") %> 2 <span><%= Me.LiteralesPage("53740") %></span></li>
        
          </ul>
        </div>
        <div class="row">

          <form action="" class="form-inline" id="ica1Form">
            <div class="invoice">
                <div class="row">
                    <ul id="messageBox"></ul>
                </div>
              ...
              <!--  <legend><%=Me.LiteralesPage("53778") %></legend>-->
                <div class="caja_formu">
                  <div class="row">
                       <label for="si"><%= Me.LiteralesPage("53776") %>:</label>
                        <input type="radio" value="1" name="p1" class="" id="RADIOP1SI" runat="server" checked="true">
                        <label for="no"><%= Me.LiteralesPage("53777") %>:</label>
                        <input type="radio" value="0" name="p1" class="" id="RADIOP1NO" runat="server">  
                       <%=Me.LiteralesPage("53730") %>                          
                  </div>
                  <div class="row"><br /></div>
                  <div class="row">
                       <label for="si"><%= Me.LiteralesPage("53776") %>:</label>
                        <input type="radio" value="1" name="p2" class="" id="RADIOP2SI" runat="server">
                        <label for="no"><%= Me.LiteralesPage("53777") %>:</label>
                        <input type="radio" value="0" name="p2" class="" id="RADIOP2NO" runat="server" checked="true">  
                       <%=Me.LiteralesPage("53731") %>   <input id="p21" style="width: 100%;" runat="server" value=""/>                       
                  </div>
                  <div class="row"><br /></div>
                  <div class="row">
                        ...
                        <div class="table-responsive  ancho_100pc">
                           <table id="tabla1" class="table table-bordered table-striped">
                              ...
                              <tr>
                                  <td ><%=Me.LiteralesPage("53732")%></td>
                                  <td ><%=Me.LiteralesPage("53733")%></td>
                                  <td ><%=Me.LiteralesPage("53735")%></td>
                                  <td ><%=Me.LiteralesPage("53736")%></td>
                                  <td ><%=Me.LiteralesPage("53737")%></td>
                                 
                              </tr>
                              <tr>
                                  <td ><input id="t11" style="width: 100%;" runat="server" value=""/></td>
                                  <td ><input id="t12" style="width: 100%;" runat="server"/></td>
                                  <td ><input id="t13" style="width: 100%;" runat="server"/></td>
                                  <td ><input id="t14" style="width: 100%;" runat="server"/></td>
                                  <td ><input id="t15" style="width: 100%;" runat="server"/></td>
                  ...
                  <div class="row">
                        <div class="table-responsive  ancho_100pc">
                           <table id="tabla2" class="table table-bordered table-striped">
                              ...
                              <tr>
                                  <td ><input id="t21" style="width: 100%;" runat="server" value=""/></td>
                                  <td ><input id="t22" style="width: 100%;" runat="server"/></td>
                                  <td ><input id="t23" style="width: 100%;" runat="server"/></td>
                                  <td ><input id="t24" style="width: 100%;" runat="server"/></td>
                                  <td ><input id="t25" style="width: 100%;" runat="server"/></td>
            ...
            <div class="botonera">
                    <a id="btnPasoAnterior" href="alta3.aspx" class="pull-left"><%= Me.LiteralesPage("50520") %></a> 
        
                   <a id="btnSiguientePaso" href="ica2.aspx" class="pull-right"><%= Me.LiteralesPage("50323") %></a>
            </div>
          </form>
        </div>
  ...
  <!-- page script -->
    ...
    <script src="JS_CSS/ica1/ica1.js?<%=Session("version") %>"></script>
</body>
