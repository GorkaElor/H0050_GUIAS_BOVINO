<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="explotacion.aspx.vb" Inherits="WEB.explotacion" %>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
             ...
             End If
          %> 
        <li class="treeview menu_explotacion menu_titulares menu_asociaciones menu_calificacion active" <%=noVisibleDatosExplotacion%>>
        <a href="#">
        ...
        <ul class="treeview-menu">
            <li class="menu_explotacion active" ><a href="explotacion.aspx" <%=noVisibleDatos%>><i class="fa fa-circle-o"></i><%= Me.Literales("50012") %></a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("51101") %></h1>
        <p><%= Me.LiteralesPage("51115") %></p>
      </section>
      ...
      <section class="content alta">
        ...
        <div class="row">
          ...
          <div class="invoice">
            ...
            <div class="row">
              <div class="col-md-12">
                <dl class="lista_datos">
                  <dt><%= Me.LiteralesPage("51102") %>:</dt>
                  <dd id="nombre" runat="server"></dd>
                  <dt><%= Me.LiteralesPage("51103") %>:</dt>
                  <dd id="direccion" runat="server"></dd>
                  <dt><%= Me.LiteralesPage("51104") %>:</dt>
                  <dd id="municipio" runat="server"></dd>
                  <dt><%= Me.LiteralesPage("51105") %>:</dt>
                  <dd id="provincia" runat="server"></dd>
                  <dt><%= Me.LiteralesPage("51106") %>:</dt>
                  <dd id="fecha_estado" runat="server"></dd>
                  <dt><%= Me.LiteralesPage("51107") %>:</dt>
                  <dd id="sistema_productivo" runat="server"></dd>
                  <dt><%= Me.LiteralesPage("51108") %>:</dt>
                  <dd id="capacidad_productiva" runat="server"></dd>
                  <dt><%= Me.LiteralesPage("51109") %>:</dt>
                  <dd id="sostenibilidad" runat="server"></dd>
                  <dt><%= Me.LiteralesPage("51110") %>:</dt>
                  <dd><input id="autoconsumo" runat="server" type="checkbox" disabled></dd>
                  <dt><%= Me.LiteralesPage("51111") %>:</dt>
                  <dd><input id="inter_intracomunitario" runat="server" type="checkbox" disabled></dd>
                  <dt><%= Me.LiteralesPage("51112") %>:</dt>
                  <dd><input id="transhumante" runat="server" type="checkbox" disabled></dd>
                  <dt><%= Me.LiteralesPage("51113") %>:</dt>
                  <dd id="observaciones" runat="server"></dd>
                  <dt><%= Me.LiteralesPage("51114") %>:</dt>
                  <dd id="clasificaciones_zootecnicas" runat="server"></dd>
                </dl>
              </div>
            </div>
