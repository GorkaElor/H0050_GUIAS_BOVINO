<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="solicitud_permiso_en_tramite.aspx.vb" Inherits="WEB.solicitud_permiso_en_tramite" %>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
       ...
       %>
        ...
        <ul class="treeview-menu">
            <li class="menu_cambio active" <%=noVisibleCambio%>><a href="cambio.aspx"><i class="fa fa-circle-o"></i><%= Me.Literales("50016") %></a></li>
        </ul>
        </li>
          <%--AYUDA Y CONTACTO--%>
       <%
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("52301") %></h1>
		<p><%= Me.LiteralesPage("52302") %></p>
        ...
        <div class="row">
          <div class="invoice permiso-crotalacion">
			   <div class="row">
				   ...
				   <div class="col-md-9">
					<h2><%= Me.LiteralesPage("52303") %></h2>
				    <p><%= Me.LiteralesPage("52307") %></p>
					<p><%= Me.LiteralesPage("52308") %></p>
					<p><%= Me.LiteralesPage("52309") %></p>
				<div>
				
			   </div>
			   
          </div>
		  </div><div class="row en-tramite">
				<div class="col-md-6 text-center"><%= Me.LiteralesPage("52304") %>: <span id="fecha_solicitud" runat="server"></span></div>
				<div class="col-md-6 text-center"><%= Me.LiteralesPage("52305") %>: <span><%= Me.LiteralesPage("52306") %></span></div>
				</div>
        </div>
		</div>
      </section>
