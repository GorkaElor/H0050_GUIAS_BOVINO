<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="solicitud_permiso_denegada.aspx.vb" Inherits="WEB.solicitud_permiso_denegada" %>
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("52401") %></h1>
		<p><%= Me.LiteralesPage("52402") %></p>
      ...
      <section class="content alta">
        ...
        <div class="row">
          <div class="invoice permiso-crotalacion">
			   <div class="row">
				   <div class="col-md-3 text-center"><img src="img/img_autocrotalacion.png" class="imagen_autocrotalacion"></div>
				   <div class="col-md-9">
					<h2><%= Me.LiteralesPage("52403") %></h2>
                    <p><%= Me.LiteralesPage("52410") %></p>
					<p><%= Me.LiteralesPage("52411") %></p>
					<p><%= Me.LiteralesPage("52412") %></p>
				<div>
				
			   </div>
			   
          </div>
		  </div><div class="row sol-rechazada text-center">
				<div class="col-md-12 text-bold" id="mensaje_rechazo" runat="server"></div>
				<div class="col-md-12"><%= Me.LiteralesPage("52407") %> <span class="text-bold">923 203 014</span> <%= Me.LiteralesPage("52409") %></div>
				<div class="col-md-6 gray-text"><%= Me.LiteralesPage("52405") %>: <span id="fecha_solicitud" runat="server"></span></div>
				<div class="col-md-6 gray-text"><%= Me.LiteralesPage("52406") %>: <span><%= Me.LiteralesPage("52408") %></span></div>
				</div>
        </div>
		</div>
      </section>
