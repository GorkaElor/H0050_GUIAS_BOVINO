<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="registro.aspx.vb" Inherits="WEB.registro" %>
...
<%--Consulta datos --%>
        ...
        <ul class="treeview-menu">
            ...
            <li class="menu_registro active"><a href="registro.aspx" <%=noVisibleLibroRegistro%>><i class="fa fa-circle-o"></i><%= Me.Literales("50011") %></a></li>
 ...
 End If
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1><%= Me.LiteralesPage("51001") %></h1>
        <p><%= Me.LiteralesPage("51004") %></p>
      </section>
          ...
          <div class="invoice">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table id="libroRegistro" class="table table-bordered table-striped">
                </table>
              </div>
            </div>
...
<!-- page script -->  
    ...
    <script src="JS_CSS/registro/registro.js?<%=Session("version") %>"></script>
</body>
