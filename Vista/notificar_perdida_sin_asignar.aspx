<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="notificar_perdida_sin_asignar.aspx.vb" Inherits="WEB.notificar_perdida_sin_asignar" %>
         ...
         <li class="treeview fase2 active" <%=noVisibleGestioCrotales%>>
              ...
              <ul class="treeview-menu">
                    ...
                    End If
                     ...
                     End If
                 %>
                 <li <%=noVisibleCrotalesDisponibles%> class="active"><a href="crotales_disponibles.aspx"><i class="fa fa-circle-o"></i><%= Me.Literales("50029") %></a></li>
...
Dim noVisibleMontesAutorizados=""
 ...
 End If
      ...
      <section class="content alta">
        ...
        <div class="row">
          <div class="invoice">              
		    ...
		    <div class="perdida-data">
		        <h3><%= Me.LiteralesPage("53602") %></h3>
		        <p><span><%= Me.LiteralesPage("53603") %>:</span><span id="id_crotal"></span></p>
		        <p><span><%= Me.LiteralesPage("53604") %>:</span><span id="fecha_actual"></span></p>
		    </div>
		  <div class="notification-body">
		    <p><%= Me.LiteralesPage("53605") %></p>
		        <ul class="custom_radios">
                  <li>
                    <input type="radio" id="f-option" name="selector" checked="checked">
                    <label for="f-option"><%= Me.LiteralesPage("53606") %></label>
                  ...
                  <li>
                    ...
                    <label for="t-option"><%= Me.LiteralesPage("53607") %></label>
    
                    <div class="check"><div class="inside"></div></div>
                  </li>
                </ul>
		    <p><%= Me.LiteralesPage("53608") %>:</p>
		    <textarea placeholder="<%= Me.LiteralesPage("53611") %>" id="observaciones"></textarea>
		  </div>

		  <div class="perdida-buttons">
		    <a href="crotales_disponibles.aspx"><button class="btn btn-default icono"><i class="fa fa-chevron-left"></i> <%= Me.LiteralesPage("53609") %></button></a>
		    <button id="btnNotificar" class="btn btn-default icono"><i class="fa fa-arrow-circle-right"></i> <%= Me.LiteralesPage("53610") %></button>
		  </div>
        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            Notificar pérdida sin asignar
                        </div>
                        <div class="modal-body">
                            <input type="hidden" name="guia" id="guia" value=""/>
                            <span id="message">Proceso completado correctamente</span>
                        </div>
  ...
  <!-- ./wrapper -->
    ...
    <script src="JS_CSS/notificar_perdida_sin_asignar/notificar_perdida_sin_asignar.js?<%=Session("version") %>"></script>
